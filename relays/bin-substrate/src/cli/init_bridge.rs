		...
		match $bridge {
			...
			InitBridgeName::RococoToWococo => {
				...
				fn encode_init_bridge(
					...
					relay_wococo_client::runtime::Call::BridgeGrandpaRococo(relay_wococo_client::runtime::BridgeGrandpaRococoCall::initialize(init_data))
				}
			...
			InitBridgeName::WococoToRococo => {
				...
				fn encode_init_bridge(
					...
					relay_rococo_client::runtime::Call::BridgeGrandpaWococo(relay_rococo_client::runtime::BridgeGrandpaWococoCall::initialize(init_data))
				}
