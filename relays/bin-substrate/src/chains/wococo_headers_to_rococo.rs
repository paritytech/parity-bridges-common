...
impl SubstrateFinalitySyncPipeline for WococoFinalityToRococo {
	...
	fn make_submit_finality_proof_transaction(
		&self,
		era: bp_runtime::TransactionEra<BlockNumberOf<Rococo>, HashOf<Rococo>>,
		...
		let transaction = Rococo::sign_transaction(genesis_hash, &self.target_sign, era, transaction_nonce, call);
