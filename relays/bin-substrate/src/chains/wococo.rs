...
impl CliEncodeCall for Wococo {
	...
	fn encode_call(call: &Call) -> anyhow::Result<Self::Call> {
		Ok(match call {
			Call::Remark { remark_payload, .. } => relay_wococo_client::runtime::Call::System(relay_wococo_client::runtime::SystemCall::remark(
			...
			Call::BridgeSendMessage {
				...
				bridge::WOCOCO_TO_ROCOCO_INDEX => {
					...
					relay_wococo_client::runtime::Call::BridgeMessagesRococo(relay_wococo_client::runtime::BridgeMessagesRococoCall::send_message(
	...
	fn get_dispatch_info(call: &relay_wococo_client::runtime::Call) -> frame_support::weights::DispatchInfo {
		match *call {
			relay_wococo_client::runtime::Call::System(relay_wococo_client::runtime::SystemCall::remark(_)) => frame_support::weights::DispatchInfo {
				weight: 1_345_000,
