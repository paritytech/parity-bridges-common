...
mod tests {
	...
	fn millau_signature_is_valid_on_rialto() {
		...
		let call = rialto_runtime::Call::System(rialto_runtime::SystemCall::remark { remark: vec![] });
	...
	fn rialto_signature_is_valid_on_millau() {
		...
		let call = millau_runtime::Call::System(millau_runtime::SystemCall::remark { remark: vec![] });
	...
	fn maximal_rialto_to_millau_message_arguments_size_is_computed_correctly() {
		...
		let call: millau_runtime::Call =
			millau_runtime::SystemCall::remark { remark: vec![42; maximal_remark_size as _] }.into();
		...
		let call: millau_runtime::Call =
			millau_runtime::SystemCall::remark { remark: vec![42; (maximal_remark_size + 1) as _] }.into();
		let payload = send_message::message_payload(
			Default::default(),
			call.get_dispatch_info().weight,
			bp_message_dispatch::CallOrigin::SourceRoot,
	...
	fn maximal_rialto_to_millau_message_dispatch_weight_is_computed_correctly() {
		...
		let call: millau_runtime::Call = rialto_runtime::SystemCall::remark { remark: vec![] }.into();
	...
	fn maximal_weight_fill_block_to_rialto_is_generated_correctly() {
		...
		let call: rialto_runtime::Call = millau_runtime::SystemCall::remark { remark: vec![] }.into();
	...
	fn rialto_tx_extra_bytes_constant_is_correct() {
		let rialto_call = rialto_runtime::Call::System(rialto_runtime::SystemCall::remark { remark: vec![] });
	...
	fn millau_tx_extra_bytes_constant_is_correct() {
		let millau_call = millau_runtime::Call::System(millau_runtime::SystemCall::remark { remark: vec![] });
