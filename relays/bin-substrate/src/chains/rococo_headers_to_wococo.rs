...
use relay_substrate_client::{BlockNumberOf, Chain, HashOf, TransactionSignScheme};
...
impl SubstrateFinalitySyncPipeline for RococoFinalityToWococo {
	...
	fn make_submit_finality_proof_transaction(
		&self,
		era: bp_runtime::TransactionEra<BlockNumberOf<Wococo>, HashOf<Wococo>>,
		...
		let transaction = Wococo::sign_transaction(genesis_hash, &self.target_sign, era, transaction_nonce, call);
