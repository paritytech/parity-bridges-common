...
pub trait BridgeInstance {
	fn build_signed_header_call(headers: Vec<QueuedEthereumHeader>) -> Call;
	fn build_unsigned_header_call(header: QueuedEthereumHeader) -> Call;
	fn build_currency_exchange_call(proof: Proof) -> Call;
}
