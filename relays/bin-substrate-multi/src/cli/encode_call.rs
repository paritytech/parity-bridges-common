...
mod tests {
	...
	fn should_encode_remark_with_default_payload() {
		// given
		let mut encode_call = EncodeCall::from_iter(vec!["encode-call", "GatewayToCircuit", "remark"]);
	...
	fn should_encode_remark_with_size() {
		// given
		let mut encode_call =
			EncodeCall::from_iter(vec!["encode-call", "GatewayToCircuit", "remark", "--remark-size", "12"]);
