...
mod tests {
	...
	type GatewayToCircuitMessagesWeights = pallet_bridge_messages::weights::RialtoWeight<gateway_runtime::Runtime>;

	#[test]
	fn select_delivery_transaction_limits_works() {
		let (max_count, max_weight) = select_delivery_transaction_limits::<GatewayToCircuitMessagesWeights>(
