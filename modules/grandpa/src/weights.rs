...
//! DATE: 2021-05-27, STEPS: [50, ], REPEAT: 20
...
pub trait WeightInfo {
	fn weight_per_additional_unique_ancestor(v: u32) -> Weight;
	fn weight_per_additional_precommit(p: u32) -> Weight;
}
...
impl<T: frame_system::Config> WeightInfo for RialtoWeight<T> {
	fn weight_per_additional_unique_ancestor(v: u32) -> Weight {
		(216_422_000 as Weight)
			.saturating_add((8_711_000 as Weight).saturating_mul(v as Weight))
			.saturating_add(T::DbWeight::get().reads(7 as Weight))
			.saturating_add(T::DbWeight::get().writes(6 as Weight))
	}
	fn weight_per_additional_precommit(p: u32) -> Weight {
		(0 as Weight)
			.saturating_add((67_278_000 as Weight).saturating_mul(p as Weight))
			.saturating_add(T::DbWeight::get().reads(7 as Weight))
			.saturating_add(T::DbWeight::get().writes(6 as Weight))
	}
}
