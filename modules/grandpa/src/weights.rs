...
//! DATE: 2021-06-01, STEPS: [50, ], REPEAT: 20
...
impl<T: frame_system::Config> WeightInfo for RialtoWeight<T> {
	fn submit_finality_proof(p: u32, v: u32) -> Weight {
		(68_198_000 as Weight)
			.saturating_add((63_378_000 as Weight).saturating_mul(p as Weight))
			.saturating_add((7_932_000 as Weight).saturating_mul(v as Weight))
