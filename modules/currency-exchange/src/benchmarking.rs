...
use super::{Call, Config as CurrencyExchangeConfig, Instance, Module as CurrencyExchangeModule, TransactionVerifier};
use sp_std::prelude::*;
...
pub trait Config<I: Instance>: CurrencyExchangeConfig<I> {
	...
	) -> <<Self as CurrencyExchangeConfig<I>>::PeerBlockchain as TransactionVerifier>::TransactionInclusionProof;
}
