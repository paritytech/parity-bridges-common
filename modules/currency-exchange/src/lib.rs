...
use bp_header_chain::TransactionVerifier;
...
pub trait Config<I = DefaultInstance>: frame_system::Config {
	...
	type PeerBlockchain: TransactionVerifier;
	/// Peer blockchain transaction parser.
	type PeerMaybeLockFundsTransaction: MaybeLockFundsTransaction<
		Transaction = <Self::PeerBlockchain as TransactionVerifier>::Transaction,
	>;
...
decl_module! {
	pub struct Module<T: Config<I>, I: Instance = DefaultInstance> for enum Call where origin: T::Origin {
		...
		pub fn import_peer_transaction(
			origin,
			proof: <<T as Config<I>>::PeerBlockchain as TransactionVerifier>::TransactionInclusionProof,
		) -> DispatchResult {
...
impl<T: Config<I>, I: Instance> Module<T, I> {
	...
	pub fn filter_transaction_proof(
		proof: &<T::PeerBlockchain as TransactionVerifier>::TransactionInclusionProof,
	) -> bool {
...
mod tests {
	...
	impl TransactionVerifier for DummyBlockchain {
