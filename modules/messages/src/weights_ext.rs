...
pub trait WeightInfoExt: WeightInfo {
	...
	/// Returns weight that needs to be accounted when receiving given the number of messages with message
	...
	/// Returns weight that needs to be accounted when receiving confirmations for given the number of
