...
pub mod pallet {
	...
	pub enum Error<T, I = ()> {
		...
		/// The outbound lane already exists.
		OutboundLaneAlreadyExists,
		/// The inbound lane already exists.
...
fn inbound_lane<T: Config<I>, I: 'static>(
	...
	LanesManager::<T, I>::new().inbound_lane(lane_id).map_err(Into::into)
}
...
fn outbound_lane<T: Config<I>, I: 'static>(
	...
	LanesManager::<T, I>::new().outbound_lane(lane_id).map_err(Into::into)
}
