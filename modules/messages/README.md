...
`pallet_bridge_messages::ConfigMAX_UNREWARDED_RELAYERS_IN_CONFIRMATION_TX` parameter. Processing weight
...
`pallet_bridge_messages::Config::MAX_UNCONFIRMED_MESSAGES_IN_CONFIRMATION_TX` parameter for that.
