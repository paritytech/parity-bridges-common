...
//! EXECUTED COMMAND:
//! target/release/runtime-codegen --full --from-wasm-file
//! bridge_hub_polkadot_runtime.compact.compressed.wasm
...
pub mod api {
	...
	impl TransactionApi {
		...
		pub fn bridge_kusama_grandpa(&self) -> bridge_kusama_grandpa::calls::TransactionApi {
			bridge_kusama_grandpa::calls::TransactionApi
		}
		pub fn bridge_kusama_parachains(&self) -> bridge_kusama_parachains::calls::TransactionApi {
			bridge_kusama_parachains::calls::TransactionApi
		}
		pub fn bridge_kusama_messages(&self) -> bridge_kusama_messages::calls::TransactionApi {
			bridge_kusama_messages::calls::TransactionApi
		}
		pub fn xcm_over_bridge_hub_kusama(
			&self,
		) -> xcm_over_bridge_hub_kusama::calls::TransactionApi {
			xcm_over_bridge_hub_kusama::calls::TransactionApi
		}
		...
		pub fn ethereum_system_v2(&self) -> ethereum_system_v2::calls::TransactionApi {
			ethereum_system_v2::calls::TransactionApi
		}
		pub fn ethereum_inbound_queue_v2(
			&self,
		) -> ethereum_inbound_queue_v2::calls::TransactionApi {
			ethereum_inbound_queue_v2::calls::TransactionApi
		}
		pub fn ethereum_outbound_queue_v2(
			&self,
		) -> ethereum_outbound_queue_v2::calls::TransactionApi {
			ethereum_outbound_queue_v2::calls::TransactionApi
		}
	...
	pub mod system {
		...
		pub mod storage {
			...
			pub mod types {
				...
				pub mod block_size {
					use super::runtime_types;
					pub type BlockSize = ::core::primitive::u32;
				}
				pub mod block_hash {
					use super::runtime_types;
				...
				pub mod blocks_till_upgrade {
					use super::runtime_types;
					pub type BlocksTillUpgrade = ::core::primitive::u8;
				}
			...
			impl StorageApi {
				...
				> {
					::subxt::ext::subxt_core::storage::address::StaticAddress::new_static(
						...
						(),
						[
							118u8, 132u8, 64u8, 194u8, 134u8, 111u8, 214u8, 62u8, 187u8, 75u8,
							239u8, 115u8, 170u8, 29u8, 99u8, 49u8, 177u8, 223u8, 130u8, 10u8, 81u8,
							190u8, 118u8, 216u8, 150u8, 206u8, 71u8, 61u8, 117u8, 86u8, 139u8,
							67u8,
						],
					)
				}
				...
				pub fn blocks_till_upgrade(
					...
					(),
					types::blocks_till_upgrade::BlocksTillUpgrade,
					::subxt::ext::subxt_core::utils::Yes,
					(),
					(),
				> {
		...
		pub mod calls {
			...
			impl TransactionApi {
				pub fn set_validation_data(
					...
					inbound_messages_data: types::set_validation_data::InboundMessagesData,
		...
		pub mod storage {
			...
			pub mod types {
				...
				pub mod block_weight_mode {
					use super::runtime_types;
					pub type BlockWeightMode = runtime_types::cumulus_pallet_parachain_system::block_weight::BlockWeightMode;
				}
				pub mod previous_core_count {
					use super::runtime_types;
					pub type PreviousCoreCount =
				...
				pub mod last_processed_downward_message {
					use super::runtime_types;
					pub type LastProcessedDownwardMessage = runtime_types::cumulus_pallet_parachain_system::parachain_inherent::InboundMessageId;
				}
				...
				pub mod last_processed_hrmp_message {
					use super::runtime_types;
					pub type LastProcessedHrmpMessage = runtime_types::cumulus_pallet_parachain_system::parachain_inherent::InboundMessageId;
				}
				...
				pub mod pending_upward_signals {
					use super::runtime_types;
					pub type PendingUpwardSignals = ::subxt::ext::subxt_core::alloc::vec::Vec<
						::subxt::ext::subxt_core::alloc::vec::Vec<::core::primitive::u8>,
					>;
				}
				pub mod pending_approved_peer {
					use super::runtime_types;
					pub type PendingApprovedPeer =
			...
			impl StorageApi {
				pub fn block_weight_mode(
					...
					(),
					types::block_weight_mode::BlockWeightMode,
					::subxt::ext::subxt_core::utils::Yes,
					(),
					(),
				> {
				...
				pub fn previous_core_count(
					...
					(),
					types::previous_core_count::PreviousCoreCount,
					::subxt::ext::subxt_core::utils::Yes,
					(),
					(),
				> {
				...
				pub fn last_processed_downward_message(
					...
					(),
					types::last_processed_downward_message::LastProcessedDownwardMessage,
					::subxt::ext::subxt_core::utils::Yes,
					(),
					(),
				> {
				...
				pub fn last_processed_hrmp_message(
					...
					(),
					types::last_processed_hrmp_message::LastProcessedHrmpMessage,
					::subxt::ext::subxt_core::utils::Yes,
					(),
					(),
				> {
				...
				pub fn pending_upward_signals(
					...
					(),
					types::pending_upward_signals::PendingUpwardSignals,
					::subxt::ext::subxt_core::utils::Yes,
					::subxt::ext::subxt_core::utils::Yes,
					(),
				> {
				...
				pub fn pending_approved_peer(
					...
					(),
					types::pending_approved_peer::PendingApprovedPeer,
					::subxt::ext::subxt_core::utils::Yes,
					(),
					(),
				> {
				...
				pub fn po_v_messages_tracker(
					...
					(),
					types::po_v_messages_tracker::PoVMessagesTracker,
					::subxt::ext::subxt_core::utils::Yes,
					(),
					(),
				> {
			...
			impl StorageApi {
				...
				> {
					::subxt::ext::subxt_core::storage::address::StaticAddress::new_static(
						...
						(),
						[
							121u8, 99u8, 131u8, 251u8, 90u8, 118u8, 162u8, 52u8, 248u8, 14u8,
							244u8, 154u8, 203u8, 61u8, 185u8, 75u8, 219u8, 126u8, 25u8, 81u8,
							120u8, 236u8, 89u8, 78u8, 50u8, 4u8, 73u8, 156u8, 162u8, 77u8, 17u8,
							177u8,
						],
					)
				}
		...
		pub mod storage {
			...
			pub mod types {
				...
				pub mod tx_payment_credit {
					use super::runtime_types;
					pub type TxPaymentCredit = runtime_types::frame_support::traits::storage::NoDrop<
	...
	pub mod session {
		...
		pub mod storage {
			...
			pub mod types {
				...
				pub mod next_keys {
					use super::runtime_types;
					pub type NextKeys = runtime_types::bridge_hub_polkadot_runtime::SessionKeys;
					pub type Param0 = ::subxt::ext::subxt_core::utils::AccountId32;
				}
				pub mod key_owner {
					use super::runtime_types;
			...
			impl StorageApi {
				...
				pub fn externally_set_keys_iter(
					&self,
				) -> ::subxt::ext::subxt_core::storage::address::StaticAddress<
					(),
					types::externally_set_keys::ExternallySetKeys,
					(),
					(),
					::subxt::ext::subxt_core::utils::Yes,
				> {
				...
				pub fn externally_set_keys(
					&self,
					_0: types::externally_set_keys::Param0,
				) -> ::subxt::ext::subxt_core::storage::address::StaticAddress<
					::subxt::ext::subxt_core::storage::address::StaticStorageKey<
						types::externally_set_keys::Param0,
					>,
					types::externally_set_keys::ExternallySetKeys,
					::subxt::ext::subxt_core::utils::Yes,
					(),
			...
			impl TransactionApi {
				pub fn batch(
					...
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						types::Batch { calls },
						[
							223u8, 251u8, 17u8, 37u8, 161u8, 49u8, 189u8, 150u8, 190u8, 80u8, 48u8,
							63u8, 244u8, 236u8, 2u8, 241u8, 129u8, 82u8, 78u8, 234u8, 142u8, 33u8,
							161u8, 218u8, 20u8, 92u8, 202u8, 192u8, 21u8, 41u8, 185u8, 124u8,
						],
					)
				}
				pub fn as_derivative(
					...
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						[
							...
							104u8, 42u8, 52u8, 8u8, 206u8, 186u8, 107u8, 180u8, 24u8, 80u8, 25u8,
							46u8,
						],
					)
				}
				pub fn batch_all(
					...
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						[
							100u8, 158u8, 30u8, 111u8, 118u8, 64u8, 34u8, 176u8, 23u8, 21u8, 176u8,
							253u8, 134u8, 243u8, 81u8, 8u8, 157u8, 154u8, 141u8, 210u8, 214u8,
							46u8, 97u8, 245u8, 228u8, 46u8, 153u8, 180u8, 141u8, 49u8, 208u8,
							165u8,
						],
					)
				}
				pub fn dispatch_as(
					...
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						[
							117u8, 252u8, 102u8, 5u8, 191u8, 253u8, 152u8, 2u8, 117u8, 20u8, 67u8,
							48u8, 47u8, 115u8, 142u8, 144u8, 98u8, 137u8, 254u8, 186u8, 187u8,
							194u8, 244u8, 141u8, 132u8, 167u8, 36u8, 83u8, 86u8, 197u8, 114u8,
							94u8,
						],
					)
				}
				pub fn force_batch(
					...
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						[
							110u8, 254u8, 38u8, 27u8, 54u8, 201u8, 224u8, 37u8, 96u8, 74u8, 90u8,
							192u8, 21u8, 45u8, 81u8, 9u8, 153u8, 242u8, 173u8, 88u8, 1u8, 102u8,
							218u8, 112u8, 88u8, 238u8, 189u8, 194u8, 54u8, 38u8, 55u8, 102u8,
						],
					)
				}
				pub fn with_weight(
					...
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						[
							...
							247u8, 231u8, 254u8, 113u8, 107u8, 21u8, 219u8, 201u8, 121u8, 210u8,
							34u8, 152u8,
						],
					)
				}
				pub fn if_else(
					...
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						[
							35u8, 97u8, 37u8, 161u8, 251u8, 217u8, 141u8, 36u8, 96u8, 69u8, 216u8,
							120u8, 15u8, 146u8, 28u8, 201u8, 119u8, 143u8, 171u8, 160u8, 62u8,
							90u8, 204u8, 233u8, 15u8, 15u8, 248u8, 173u8, 103u8, 247u8, 234u8,
							80u8,
						],
					)
				}
			...
			impl TransactionApi {
				...
				) -> ::subxt::ext::subxt_core::tx::payload::StaticPayload<types::AsMultiThreshold1>
				{
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						[
							168u8, 87u8, 218u8, 202u8, 253u8, 52u8, 98u8, 88u8, 105u8, 20u8, 165u8,
							12u8, 217u8, 77u8, 39u8, 69u8, 48u8, 174u8, 239u8, 85u8, 106u8, 230u8,
							73u8, 110u8, 21u8, 144u8, 37u8, 51u8, 25u8, 54u8, 138u8, 10u8,
						],
					)
				}
				pub fn as_multi(
					...
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						[
							205u8, 13u8, 113u8, 6u8, 120u8, 137u8, 138u8, 218u8, 189u8, 60u8, 25u8,
							12u8, 197u8, 146u8, 175u8, 115u8, 76u8, 71u8, 18u8, 47u8, 202u8, 173u8,
							192u8, 81u8, 84u8, 0u8, 115u8, 107u8, 30u8, 179u8, 131u8, 226u8,
						],
					)
				}
			...
			impl TransactionApi {
				...
				pub fn add_proxy(
					...
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						[
							18u8, 237u8, 17u8, 136u8, 4u8, 103u8, 91u8, 16u8, 255u8, 88u8, 55u8,
							179u8, 150u8, 237u8, 113u8, 40u8, 31u8, 111u8, 9u8, 219u8, 219u8, 14u8,
							76u8, 36u8, 110u8, 241u8, 108u8, 48u8, 121u8, 99u8, 43u8, 226u8,
						],
					)
				}
				pub fn remove_proxy(
					...
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						[
							...
							254u8, 88u8, 81u8, 129u8, 181u8, 54u8, 40u8, 13u8, 192u8, 255u8, 196u8,
							91u8, 221u8, 61u8, 35u8, 22u8, 150u8, 200u8, 107u8, 187u8, 216u8,
							132u8,
						],
					)
				}
				...
				pub fn create_pure(
					...
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						[
							73u8, 77u8, 7u8, 253u8, 167u8, 150u8, 178u8, 202u8, 101u8, 96u8, 34u8,
							58u8, 170u8, 137u8, 209u8, 185u8, 248u8, 144u8, 82u8, 155u8, 210u8,
							135u8, 186u8, 11u8, 162u8, 230u8, 108u8, 161u8, 32u8, 233u8, 99u8,
							133u8,
						],
					)
				}
				pub fn kill_pure(
					...
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						[
							...
							86u8, 14u8, 134u8, 234u8, 38u8, 106u8, 192u8, 48u8, 193u8, 35u8, 38u8,
							12u8,
						],
					)
				}
			...
			impl StorageApi {
				...
				> {
					::subxt::ext::subxt_core::storage::address::StaticAddress::new_static(
						...
						(),
						[
							255u8, 243u8, 159u8, 37u8, 135u8, 49u8, 152u8, 171u8, 74u8, 87u8, 84u8,
							130u8, 250u8, 56u8, 132u8, 157u8, 196u8, 121u8, 235u8, 106u8, 66u8,
							248u8, 28u8, 21u8, 248u8, 167u8, 230u8, 102u8, 164u8, 94u8, 64u8,
							246u8,
						],
					)
				}
		...
		pub mod calls {
			...
			pub mod types {
				...
				pub mod claim_rewards {
					use super::runtime_types;
					pub type RewardKind = runtime_types::bridge_hub_polkadot_runtime::bridge_common_config::BridgeReward;
				}
			...
			impl TransactionApi {
				pub fn claim_rewards(
					...
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						[
							182u8, 199u8, 205u8, 76u8, 164u8, 2u8, 65u8, 224u8, 226u8, 251u8, 70u8,
							151u8, 233u8, 118u8, 230u8, 226u8, 19u8, 145u8, 141u8, 158u8, 102u8,
							26u8, 172u8, 51u8, 146u8, 148u8, 208u8, 152u8, 87u8, 170u8, 253u8,
							247u8,
						],
					)
				}
				...
				) -> ::subxt::ext::subxt_core::tx::payload::StaticPayload<types::ClaimRewardsTo>
				{
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						[
							...
							149u8, 53u8, 237u8, 78u8, 187u8, 126u8, 109u8, 30u8, 120u8, 49u8, 97u8,
							77u8,
						],
					)
				}
			...
			impl StorageApi {
				...
				> {
					::subxt::ext::subxt_core::storage::address::StaticAddress::new_static(
						...
						(),
						[
							65u8, 134u8, 30u8, 187u8, 102u8, 235u8, 148u8, 203u8, 208u8, 52u8,
							247u8, 232u8, 137u8, 96u8, 232u8, 102u8, 168u8, 53u8, 104u8, 192u8,
							138u8, 48u8, 21u8, 192u8, 227u8, 139u8, 28u8, 14u8, 138u8, 146u8,
							201u8, 193u8,
						],
					)
				}
		...
		pub mod calls {
			...
			pub mod types {
				...
				impl ::subxt::ext::subxt_core::blocks::StaticExtrinsic for SubmitFinalityProof {
					const PALLET: &'static str = "BridgeKusamaGrandpa";
		...
		pub mod calls {
			...
			pub mod types {
				...
				impl ::subxt::ext::subxt_core::blocks::StaticExtrinsic for SubmitParachainHeads {
					const PALLET: &'static str = "BridgeKusamaParachains";
	...
	pub mod bridge_kusama_messages {
		...
		pub mod calls {
			...
			pub mod types {
				...
				impl ::subxt::ext::subxt_core::blocks::StaticExtrinsic for SetOwner {
					const PALLET: &'static str = "BridgeKusamaMessages";
					const CALL: &'static str = "set_owner";
				}
				#[derive(
					::subxt::ext::subxt_core::ext::scale_decode::DecodeAsType,
		...
		pub mod calls {
			...
			pub mod types {
				...
				impl ::subxt::ext::subxt_core::blocks::StaticExtrinsic for OpenBridge {
					const PALLET: &'static str = "XcmOverBridgeHubKusama";
			...
			impl TransactionApi {
				pub fn submit(
					...
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						types::Submit { event },
						[
							28u8, 68u8, 151u8, 64u8, 87u8, 51u8, 85u8, 153u8, 239u8, 227u8, 234u8,
							171u8, 117u8, 59u8, 161u8, 209u8, 172u8, 128u8, 102u8, 193u8, 150u8,
							47u8, 120u8, 177u8, 70u8, 132u8, 106u8, 58u8, 209u8, 63u8, 128u8, 10u8,
						],
					)
				}
				pub fn set_operating_mode(
			...
			impl StorageApi {
				...
				> {
					::subxt::ext::subxt_core::storage::address::StaticAddress::new_static(
						...
						(),
						[
							232u8, 235u8, 46u8, 46u8, 223u8, 153u8, 155u8, 195u8, 165u8, 238u8,
							104u8, 93u8, 162u8, 98u8, 105u8, 47u8, 151u8, 181u8, 182u8, 118u8,
							185u8, 17u8, 242u8, 73u8, 215u8, 206u8, 236u8, 34u8, 223u8, 24u8, 15u8,
							129u8,
						],
					)
				}
	...
	pub mod ethereum_system_v2 {
		...
		pub mod calls {
			...
			pub mod types {
				...
				pub mod upgrade {
					...
					pub type ImplAddress = ::subxt::ext::subxt_core::utils::H160;
					pub type ImplCodeHash = ::subxt::ext::subxt_core::utils::H256;
					pub type Initializer = runtime_types::snowbridge_outbound_queue_primitives::v2::message::Initializer;
				}
				impl ::subxt::ext::subxt_core::blocks::StaticExtrinsic for Upgrade {
					const PALLET: &'static str = "EthereumSystemV2";
					const CALL: &'static str = "upgrade";
				}
				#[derive(
					::subxt::ext::subxt_core::ext::scale_decode::DecodeAsType,
				...
				pub struct RegisterToken {
					pub sender: ::subxt::ext::subxt_core::alloc::boxed::Box<register_token::Sender>,
					pub asset_id:
						::subxt::ext::subxt_core::alloc::boxed::Box<register_token::AssetId>,
					pub metadata: register_token::Metadata,
				...
				impl ::subxt::ext::subxt_core::blocks::StaticExtrinsic for AddTip {
					const PALLET: &'static str = "EthereumSystemV2";
					const CALL: &'static str = "add_tip";
				}
			}
			pub struct TransactionApi;
			impl TransactionApi {
				pub fn upgrade(
					...
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						types::Upgrade { impl_address, impl_code_hash, initializer },
						[
							199u8, 222u8, 75u8, 112u8, 98u8, 220u8, 65u8, 85u8, 243u8, 137u8, 85u8,
							186u8, 60u8, 186u8, 176u8, 80u8, 178u8, 59u8, 17u8, 194u8, 234u8, 2u8,
							140u8, 109u8, 122u8, 72u8, 56u8, 87u8, 109u8, 63u8, 88u8, 42u8,
						],
					)
				}
				pub fn set_operating_mode(
				...
				pub fn register_token(
					&self,
					sender: types::register_token::Sender,
					asset_id: types::register_token::AssetId,
					metadata: types::register_token::Metadata,
					amount: types::register_token::Amount,
				) -> ::subxt::ext::subxt_core::tx::payload::StaticPayload<types::RegisterToken>
				{
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						"EthereumSystemV2",
						"register_token",
						types::RegisterToken {
							sender: ::subxt::ext::subxt_core::alloc::boxed::Box::new(sender),
							asset_id: ::subxt::ext::subxt_core::alloc::boxed::Box::new(asset_id),
							metadata,
							amount,
						},
						[
				...
				pub fn add_tip(
					&self,
					sender: types::add_tip::Sender,
					message_id: types::add_tip::MessageId,
					amount: types::add_tip::Amount,
				) -> ::subxt::ext::subxt_core::tx::payload::StaticPayload<types::AddTip> {
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						"EthereumSystemV2",
						"add_tip",
						types::AddTip { sender, message_id, amount },
						[
							161u8, 228u8, 2u8, 211u8, 37u8, 83u8, 93u8, 171u8, 74u8, 56u8, 155u8,
							16u8, 220u8, 212u8, 170u8, 112u8, 159u8, 78u8, 190u8, 95u8, 78u8,
							210u8, 79u8, 250u8, 9u8, 86u8, 126u8, 148u8, 82u8, 16u8, 175u8, 211u8,
						],
					)
				}
			}
		...
		pub mod events {
			...
			pub mod upgrade {
				...
				pub type ImplAddress = ::subxt::ext::subxt_core::utils::H160;
				pub type ImplCodeHash = ::subxt::ext::subxt_core::utils::H256;
				pub type InitializerParamsHash = ::subxt::ext::subxt_core::utils::H256;
			}
			impl ::subxt::ext::subxt_core::events::StaticEvent for Upgrade {
				const PALLET: &'static str = "EthereumSystemV2";
				const EVENT: &'static str = "Upgrade";
			...
			impl ::subxt::ext::subxt_core::events::StaticEvent for TipProcessed {
				const PALLET: &'static str = "EthereumSystemV2";
				const EVENT: &'static str = "TipProcessed";
			}
		}
		pub mod storage {
			use super::runtime_types;
			pub mod types {
				...
				pub mod lost_tips {
					use super::runtime_types;
					pub type LostTips = ::core::primitive::u128;
					pub type Param0 = ::subxt::ext::subxt_core::utils::AccountId32;
				}
			}
			pub struct StorageApi;
			impl StorageApi {
				pub fn lost_tips_iter(
					&self,
				) -> ::subxt::ext::subxt_core::storage::address::StaticAddress<
					(),
					types::lost_tips::LostTips,
					(),
					::subxt::ext::subxt_core::utils::Yes,
					::subxt::ext::subxt_core::utils::Yes,
				> {
					::subxt::ext::subxt_core::storage::address::StaticAddress::new_static(
						...
						(),
						[
							235u8, 10u8, 7u8, 131u8, 252u8, 20u8, 5u8, 125u8, 232u8, 125u8, 228u8,
							174u8, 108u8, 195u8, 146u8, 179u8, 165u8, 232u8, 168u8, 186u8, 7u8,
							33u8, 194u8, 188u8, 122u8, 224u8, 11u8, 223u8, 2u8, 77u8, 124u8, 78u8,
						],
					)
				}
				pub fn lost_tips(
					&self,
					_0: types::lost_tips::Param0,
				) -> ::subxt::ext::subxt_core::storage::address::StaticAddress<
					::subxt::ext::subxt_core::storage::address::StaticStorageKey<
						types::lost_tips::Param0,
					>,
					types::lost_tips::LostTips,
					::subxt::ext::subxt_core::utils::Yes,
					::subxt::ext::subxt_core::utils::Yes,
	...
	pub mod ethereum_inbound_queue_v2 {
		...
		pub mod calls {
			...
			pub mod types {
				...
				pub struct Submit {
					pub event: ::subxt::ext::subxt_core::alloc::boxed::Box<submit::Event>,
				}
				pub mod submit {
					use super::runtime_types;
					pub type Event = runtime_types::snowbridge_verification_primitives::EventProof;
				...
				impl ::subxt::ext::subxt_core::blocks::StaticExtrinsic for Submit {
					const PALLET: &'static str = "EthereumInboundQueueV2";
					const CALL: &'static str = "submit";
				}
				#[derive(
					::subxt::ext::subxt_core::ext::scale_decode::DecodeAsType,
			...
			impl TransactionApi {
				pub fn submit(
					...
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						...
						"submit",
						types::Submit {
							event: ::subxt::ext::subxt_core::alloc::boxed::Box::new(event),
						},
						[
							28u8, 68u8, 151u8, 64u8, 87u8, 51u8, 85u8, 153u8, 239u8, 227u8, 234u8,
							171u8, 117u8, 59u8, 161u8, 209u8, 172u8, 128u8, 102u8, 193u8, 150u8,
		...
		pub mod storage {
			...
			pub mod types {
				...
				pub mod nonce_bitmap {
					use super::runtime_types;
					pub type NonceBitmap = ::core::primitive::u128;
					pub type Param0 = ::core::primitive::u64;
				}
				pub mod operating_mode {
					use super::runtime_types;
				...
				pub mod tips {
					use super::runtime_types;
					pub type Tips = ::core::primitive::u128;
					pub type Param0 = ::core::primitive::u64;
				}
			}
			pub struct StorageApi;
			impl StorageApi {
				pub fn nonce_bitmap_iter(
					&self,
				) -> ::subxt::ext::subxt_core::storage::address::StaticAddress<
					(),
					types::nonce_bitmap::NonceBitmap,
					(),
					::subxt::ext::subxt_core::utils::Yes,
					::subxt::ext::subxt_core::utils::Yes,
				> {
					::subxt::ext::subxt_core::storage::address::StaticAddress::new_static(
						...
						(),
						[
							123u8, 151u8, 60u8, 176u8, 44u8, 226u8, 198u8, 17u8, 127u8, 15u8,
							211u8, 195u8, 38u8, 26u8, 75u8, 176u8, 78u8, 214u8, 101u8, 211u8,
							216u8, 178u8, 176u8, 64u8, 206u8, 38u8, 134u8, 25u8, 47u8, 12u8, 80u8,
							218u8,
						],
					)
				}
				pub fn nonce_bitmap(
					&self,
					_0: types::nonce_bitmap::Param0,
				) -> ::subxt::ext::subxt_core::storage::address::StaticAddress<
					::subxt::ext::subxt_core::storage::address::StaticStorageKey<
						types::nonce_bitmap::Param0,
					>,
					types::nonce_bitmap::NonceBitmap,
					::subxt::ext::subxt_core::utils::Yes,
					::subxt::ext::subxt_core::utils::Yes,
				...
				> {
					::subxt::ext::subxt_core::storage::address::StaticAddress::new_static(
						...
						(),
						[
							111u8, 216u8, 241u8, 193u8, 112u8, 136u8, 119u8, 219u8, 238u8, 249u8,
							110u8, 8u8, 35u8, 113u8, 9u8, 205u8, 79u8, 11u8, 82u8, 146u8, 190u8,
							75u8, 106u8, 102u8, 211u8, 172u8, 126u8, 109u8, 23u8, 79u8, 214u8,
							137u8,
						],
					)
				}
	...
	pub mod ethereum_outbound_queue_v2 {
		...
		pub mod calls {
			...
			pub mod types {
				...
				pub struct SubmitDeliveryReceipt {
					pub event:
						::subxt::ext::subxt_core::alloc::boxed::Box<submit_delivery_receipt::Event>,
				}
				pub mod submit_delivery_receipt {
					use super::runtime_types;
					pub type Event = runtime_types::snowbridge_verification_primitives::EventProof;
				}
				impl ::subxt::ext::subxt_core::blocks::StaticExtrinsic for SubmitDeliveryReceipt {
					const PALLET: &'static str = "EthereumOutboundQueueV2";
					const CALL: &'static str = "submit_delivery_receipt";
				}
			}
			pub struct TransactionApi;
			impl TransactionApi {
				pub fn submit_delivery_receipt(
					&self,
					event: types::submit_delivery_receipt::Event,
				) -> ::subxt::ext::subxt_core::tx::payload::StaticPayload<
					types::SubmitDeliveryReceipt,
				> {
					::subxt::ext::subxt_core::tx::payload::StaticPayload::new_static(
						"EthereumOutboundQueueV2",
						...
						[
							210u8, 40u8, 12u8, 160u8, 131u8, 29u8, 166u8, 80u8, 116u8, 75u8, 203u8,
							30u8, 28u8, 158u8, 136u8, 238u8, 161u8, 136u8, 57u8, 160u8, 2u8, 173u8,
							108u8, 34u8, 145u8, 48u8, 216u8, 117u8, 130u8, 169u8, 42u8, 41u8,
						],
					)
				}
			}
		...
		pub mod events {
			...
			pub mod message_rejected {
				use super::runtime_types;
				pub type Id = ::core::option::Option<::subxt::ext::subxt_core::utils::H256>;
			...
			impl ::subxt::ext::subxt_core::events::StaticEvent for MessageRejected {
				const PALLET: &'static str = "EthereumOutboundQueueV2";
			...
			impl ::subxt::ext::subxt_core::events::StaticEvent for MessagePostponed {
				const PALLET: &'static str = "EthereumOutboundQueueV2";
				const EVENT: &'static str = "MessagePostponed";
			}
			#[derive(
				::subxt::ext::subxt_core::ext::scale_decode::DecodeAsType,
				::subxt::ext::subxt_core::ext::scale_encode::EncodeAsType,
			...
			impl ::subxt::ext::subxt_core::events::StaticEvent for MessageDelivered {
				const PALLET: &'static str = "EthereumOutboundQueueV2";
				const EVENT: &'static str = "MessageDelivered";
			}
		}
		pub mod storage {
			use super::runtime_types;
			...
			impl StorageApi {
				...
				> {
					::subxt::ext::subxt_core::storage::address::StaticAddress::new_static(
						...
						(),
						[
							39u8, 77u8, 78u8, 196u8, 190u8, 144u8, 188u8, 151u8, 44u8, 229u8, 62u8,
							102u8, 29u8, 70u8, 129u8, 51u8, 92u8, 204u8, 78u8, 248u8, 210u8, 245u8,
							108u8, 127u8, 133u8, 192u8, 234u8, 89u8, 31u8, 241u8, 15u8, 19u8,
						],
					)
				}
				pub fn message_leaves(
				...
				pub fn pending_orders_iter(
					&self,
				) -> ::subxt::ext::subxt_core::storage::address::StaticAddress<
					(),
					types::pending_orders::PendingOrders,
					(),
					(),
					::subxt::ext::subxt_core::utils::Yes,
				> {
					::subxt::ext::subxt_core::storage::address::StaticAddress::new_static(
						...
						(),
						[
							197u8, 249u8, 69u8, 252u8, 118u8, 100u8, 115u8, 220u8, 182u8, 42u8,
							229u8, 227u8, 20u8, 215u8, 236u8, 82u8, 21u8, 143u8, 151u8, 61u8,
							253u8, 241u8, 93u8, 142u8, 14u8, 27u8, 179u8, 197u8, 193u8, 155u8,
							235u8, 244u8,
						],
					)
				}
				pub fn pending_orders(
					&self,
					_0: types::pending_orders::Param0,
				) -> ::subxt::ext::subxt_core::storage::address::StaticAddress<
					::subxt::ext::subxt_core::storage::address::StaticStorageKey<
						types::pending_orders::Param0,
					>,
					types::pending_orders::PendingOrders,
					::subxt::ext::subxt_core::utils::Yes,
					(),
		...
		pub mod bridge_hub_polkadot_runtime {
			...
			pub mod bridge_common_config {
				...
				pub enum BridgeRewardBeneficiaries {
					#[codec(index = 0)]
					LocalAccount(::subxt::ext::subxt_core::utils::AccountId32),
					#[codec(index = 1)]
					AssetHubLocation(
						::subxt::ext::subxt_core::alloc::boxed::Box<
							runtime_types::xcm::VersionedLocation,
				...
				pub mod message {
					...
					pub enum Command {
                        ...
                        RegisterForeignToken {
                            token_id: ::subxt::ext::subxt_core::utils::H256,
                        ...
                        CallContract {
                            ...
                            calldata: ::subxt::ext::subxt_core::alloc::vec::Vec<
                                ::core::primitive::u8,
                            >,
					...
					pub struct Message {
                        pub origin: ::subxt::ext::subxt_core::utils::H256,
					...
					pub struct OutboundMessage {
                        pub origin: ::subxt::ext::subxt_core::utils::H256,
                        pub nonce: ::core::primitive::u64,
                        pub topic: ::subxt::ext::subxt_core::utils::H256,
                        pub commands: runtime_types::bounded_collections::bounded_vec::BoundedVec<
		...
		pub mod snowbridge_pallet_inbound_queue_v2 {
			...
			pub mod pallet {
				...
				pub enum Call {
					#[codec(index = 0)]
					submit {
						event: ::subxt::ext::subxt_core::alloc::boxed::Box<
				...
				pub enum Event {
                    ...
                    MessageRejected {
                        id: ::core::option::Option<
                            ::subxt::ext::subxt_core::utils::H256,
                        >,
                        payload: ::subxt::ext::subxt_core::alloc::vec::Vec<
                            ::core::primitive::u8,
                        >,
                        error: runtime_types::frame_support::traits::messages::ProcessMessageError,
                    },
		...
		pub mod snowbridge_pallet_system_v2 {
			...
			pub mod pallet {
				...
				pub enum Call {
                    ...
                    #[codec(index = 2)]
                    register_token {
                        sender: ::subxt::ext::subxt_core::alloc::boxed::Box<
                            runtime_types::xcm::VersionedLocation,
                        >,
				...
				pub enum Event {
					...
					Upgrade {
						impl_address: ::subxt::ext::subxt_core::utils::H160,
						impl_code_hash: ::subxt::ext::subxt_core::utils::H256,
						initializer_params_hash: ::subxt::ext::subxt_core::utils::H256,
					},
					#[codec(index = 1)]
					SetOperatingMode {
						mode: runtime_types::snowbridge_outbound_queue_primitives::OperatingMode,
