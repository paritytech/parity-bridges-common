...
//! EXECUTED COMMAND: target/release/runtime-codegen --full --from-wasm-file
//! bridge-hub-westend-runtime/bridge_hub_westend_runtime.wasm
...
pub mod api {
	...
	pub type Event = runtime_types::bridge_hub_westend_runtime::RuntimeEvent;
	/// The outer extrinsic enum.
	pub type Call = runtime_types::bridge_hub_westend_runtime::RuntimeCall;
	/// The outer error enum represents the DispatchError's Module variant.
	pub type Error = runtime_types::bridge_hub_westend_runtime::RuntimeError;
	...
	impl ConstantsApi {
		...
		pub fn accumulate_forward(&self) -> accumulate_forward::constants::ConstantsApi {
			accumulate_forward::constants::ConstantsApi
		}
		...
		pub fn xcm_over_bridge_hub_rococo(
			&self,
		) -> xcm_over_bridge_hub_rococo::constants::ConstantsApi {
			xcm_over_bridge_hub_rococo::constants::ConstantsApi
		}
	...
	impl StorageApi {
		...
		pub fn bridge_rococo_parachains(&self) -> bridge_rococo_parachains::storage::StorageApi {
			bridge_rococo_parachains::storage::StorageApi
		}
		...
		pub fn xcm_over_bridge_hub_rococo(
			&self,
		) -> xcm_over_bridge_hub_rococo::storage::StorageApi {
			xcm_over_bridge_hub_rococo::storage::StorageApi
		}
	...
	impl TransactionApi {
		...
		pub fn bridge_rococo_grandpa(&self) -> bridge_rococo_grandpa::calls::api::TransactionApi {
			bridge_rococo_grandpa::calls::api::TransactionApi
		}
		pub fn bridge_rococo_parachains(
			&self,
		) -> bridge_rococo_parachains::calls::api::TransactionApi {
			bridge_rococo_parachains::calls::api::TransactionApi
		}
		pub fn bridge_rococo_messages(&self) -> bridge_rococo_messages::calls::api::TransactionApi {
			bridge_rococo_messages::calls::api::TransactionApi
		}
		pub fn xcm_over_bridge_hub_rococo(
			&self,
		) -> xcm_over_bridge_hub_rococo::calls::api::TransactionApi {
			xcm_over_bridge_hub_rococo::calls::api::TransactionApi
		}
	...
	pub fn is_codegen_valid_for(metadata: &::subxt::Metadata) -> bool {
		...
		runtime_metadata_hash ==
			[
				208u8, 101u8, 189u8, 79u8, 51u8, 154u8, 161u8, 43u8, 216u8, 34u8, 248u8, 230u8,
				148u8, 194u8, 147u8, 146u8, 255u8, 168u8, 143u8, 176u8, 66u8, 93u8, 50u8, 216u8,
				151u8, 93u8, 234u8, 23u8, 204u8, 91u8, 161u8, 225u8,
			]
	}
	pub mod system {
		use super::{root_mod, runtime_types};
			...
			impl StorageApi {
				...
				pub fn events(
					...
					::subxt::storage::StaticAddress::new_static(
						...
						"Events",
						[
							59u8, 157u8, 51u8, 67u8, 1u8, 52u8, 191u8, 167u8, 189u8, 111u8, 133u8,
							242u8, 47u8, 82u8, 96u8, 115u8, 15u8, 125u8, 181u8, 79u8, 141u8, 157u8,
							48u8, 83u8, 47u8, 177u8, 184u8, 197u8, 207u8, 14u8, 143u8, 243u8,
						],
					)
				}
				pub fn event_count(
			...
			pub mod events {
				...
				pub type Output = ::subxt::alloc::vec::Vec<
					runtime_types::frame_system::EventRecord<
						runtime_types::bridge_hub_westend_runtime::RuntimeEvent,
						::subxt::utils::H256,
					>,
				>;
			}
	...
	pub mod balances {
		...
		pub mod events {
			...
			pub mod held {
				use super::runtime_types;
				pub type Reason = runtime_types::bridge_hub_westend_runtime::RuntimeHoldReason;
				pub type Who = ::subxt::utils::AccountId32;
				pub type Amount = ::core::primitive::u128;
			}
			impl Held {
			...
			impl StorageApi {
				...
				> {
					::subxt::storage::StaticAddress::new_static(
						...
						"Holds",
						[
							176u8, 187u8, 200u8, 2u8, 202u8, 23u8, 123u8, 55u8, 138u8, 54u8, 247u8,
							245u8, 203u8, 161u8, 242u8, 23u8, 88u8, 13u8, 219u8, 141u8, 140u8,
							11u8, 5u8, 66u8, 215u8, 194u8, 36u8, 98u8, 204u8, 44u8, 36u8, 70u8,
						],
					)
				}
				pub fn freezes(
			...
			pub mod holds {
				...
				pub type Output = runtime_types::bounded_collections::bounded_vec::BoundedVec<
					runtime_types::frame_support::traits::tokens::misc::IdAmount<
						runtime_types::bridge_hub_westend_runtime::RuntimeHoldReason,
						::core::primitive::u128,
					>,
				>;
			}
	...
	pub mod accumulate_forward {
		use super::{root_mod, runtime_types};
		pub type Event = runtime_types::pallet_accumulate_and_forward::pallet::Event;
		pub mod events {
			use super::runtime_types;
			#[derive(
				::subxt::ext::scale_decode::DecodeAsType,
			...
			#[decode_as_type(crate_path = ":: subxt :: ext :: scale_decode")]
			#[encode_as_type(crate_path = ":: subxt :: ext :: scale_encode")]
			pub struct ForwardSucceeded {
				pub amount: forward_succeeded::Amount,
			}
			pub mod forward_succeeded {
				use super::runtime_types;
				pub type Amount = ::core::primitive::u128;
			}
			impl ForwardSucceeded {
				const PALLET_NAME: &'static str = "AccumulateForward";
				const EVENT_NAME: &'static str = "ForwardSucceeded";
			}
			impl ::subxt::events::DecodeAsEvent for ForwardSucceeded {
				fn is_event(pallet_name: &str, event_name: &str) -> bool {
					pallet_name == Self::PALLET_NAME && event_name == Self::EVENT_NAME
				}
			}
			...
			pub struct ForwardFailed {
				pub amount: forward_failed::Amount,
			}
			pub mod forward_failed {
				use super::runtime_types;
				pub type Amount = ::core::primitive::u128;
			}
			impl ForwardFailed {
				const PALLET_NAME: &'static str = "AccumulateForward";
				const EVENT_NAME: &'static str = "ForwardFailed";
			}
			impl ::subxt::events::DecodeAsEvent for ForwardFailed {
				fn is_event(pallet_name: &str, event_name: &str) -> bool {
					pallet_name == Self::PALLET_NAME && event_name == Self::EVENT_NAME
				}
			}
	...
	pub mod session {
		...
		pub mod calls {
			...
			pub mod set_keys {
				use super::runtime_types;
				pub type Keys = runtime_types::bridge_hub_westend_runtime::SessionKeys;
		...
		pub mod storage {
			...
			pub mod queued_keys {
				...
				pub type Output = ::subxt::alloc::vec::Vec<(
					::subxt::utils::AccountId32,
					runtime_types::bridge_hub_westend_runtime::SessionKeys,
				)>;
			}
			...
			pub mod next_keys {
				...
				pub type Output = runtime_types::bridge_hub_westend_runtime::SessionKeys;
			}
			pub mod key_owner {
				use super::{root_mod, runtime_types};
				pub mod input {
	...
	pub mod utility {
		...
		pub mod calls {
			...
			pub mod dispatch_as {
				use super::runtime_types;
				pub type AsOrigin = runtime_types::bridge_hub_westend_runtime::OriginCaller;
				pub type Call = runtime_types::bridge_hub_westend_runtime::RuntimeCall;
			}
			impl DispatchAs {
				const PALLET_NAME: &'static str = "Utility";
			...
			pub mod if_else {
				use super::runtime_types;
				pub type Main = runtime_types::bridge_hub_westend_runtime::RuntimeCall;
				pub type Fallback = runtime_types::bridge_hub_westend_runtime::RuntimeCall;
			}
			impl IfElse {
				const PALLET_NAME: &'static str = "Utility";
				...
				impl TransactionApi {
					pub fn batch(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							super::Batch { calls },
							[
								213u8, 165u8, 69u8, 112u8, 14u8, 234u8, 27u8, 99u8, 108u8, 161u8,
								20u8, 129u8, 222u8, 217u8, 198u8, 31u8, 19u8, 191u8, 70u8, 196u8,
								129u8, 139u8, 11u8, 31u8, 213u8, 215u8, 128u8, 206u8, 248u8, 184u8,
								100u8, 43u8,
							],
						)
					}
					pub fn as_derivative(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								78u8, 238u8, 199u8, 35u8, 100u8, 97u8, 149u8, 24u8, 193u8, 238u8,
								4u8, 156u8, 66u8, 238u8, 128u8, 101u8, 31u8, 47u8, 183u8, 253u8,
								196u8, 78u8, 159u8, 75u8, 18u8, 24u8, 237u8, 111u8, 5u8, 0u8,
								211u8, 168u8,
							],
						)
					}
					pub fn batch_all(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								37u8, 115u8, 208u8, 195u8, 121u8, 40u8, 249u8, 43u8, 144u8, 69u8,
								65u8, 45u8, 78u8, 75u8, 43u8, 224u8, 231u8, 134u8, 112u8, 37u8,
								224u8, 162u8, 248u8, 82u8, 204u8, 74u8, 218u8, 197u8, 187u8, 54u8,
								201u8, 237u8,
							],
						)
					}
					pub fn dispatch_as(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								162u8, 164u8, 152u8, 13u8, 235u8, 54u8, 183u8, 170u8, 172u8, 0u8,
								6u8, 190u8, 85u8, 94u8, 255u8, 200u8, 29u8, 219u8, 103u8, 242u8,
								228u8, 179u8, 114u8, 45u8, 216u8, 20u8, 91u8, 23u8, 46u8, 72u8,
								217u8, 87u8,
							],
						)
					}
					pub fn force_batch(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								89u8, 11u8, 177u8, 149u8, 243u8, 180u8, 59u8, 255u8, 34u8, 103u8,
								49u8, 251u8, 162u8, 72u8, 104u8, 144u8, 121u8, 160u8, 217u8, 112u8,
								45u8, 37u8, 140u8, 186u8, 183u8, 34u8, 158u8, 87u8, 69u8, 88u8,
								108u8, 244u8,
							],
						)
					}
					pub fn with_weight(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								199u8, 50u8, 213u8, 80u8, 140u8, 232u8, 50u8, 228u8, 227u8, 197u8,
								114u8, 53u8, 230u8, 132u8, 201u8, 183u8, 193u8, 169u8, 192u8,
								234u8, 43u8, 248u8, 190u8, 164u8, 204u8, 97u8, 78u8, 180u8, 67u8,
								61u8, 107u8, 178u8,
							],
						)
					}
					pub fn if_else(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								12u8, 198u8, 18u8, 12u8, 163u8, 255u8, 212u8, 121u8, 203u8, 187u8,
								88u8, 168u8, 246u8, 156u8, 155u8, 50u8, 127u8, 36u8, 186u8, 251u8,
								116u8, 112u8, 50u8, 149u8, 31u8, 101u8, 144u8, 70u8, 253u8, 95u8,
								76u8, 99u8,
							],
						)
					}
					pub fn dispatch_as_fallible(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								1u8, 14u8, 251u8, 104u8, 103u8, 6u8, 22u8, 213u8, 8u8, 13u8, 61u8,
								171u8, 139u8, 37u8, 15u8, 147u8, 46u8, 141u8, 221u8, 161u8, 92u8,
								151u8, 39u8, 173u8, 90u8, 253u8, 186u8, 48u8, 204u8, 175u8, 56u8,
								105u8,
							],
						)
					}
				...
				impl TransactionApi {
					pub fn as_multi_threshold_1(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								32u8, 67u8, 171u8, 118u8, 5u8, 13u8, 74u8, 84u8, 234u8, 72u8,
								101u8, 34u8, 141u8, 232u8, 113u8, 159u8, 89u8, 234u8, 93u8, 183u8,
								123u8, 215u8, 154u8, 6u8, 231u8, 111u8, 11u8, 248u8, 94u8, 127u8,
								220u8, 95u8,
							],
						)
					}
					pub fn as_multi(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								83u8, 136u8, 224u8, 77u8, 117u8, 47u8, 209u8, 15u8, 74u8, 122u8,
								236u8, 66u8, 89u8, 104u8, 188u8, 71u8, 214u8, 122u8, 197u8, 188u8,
								135u8, 226u8, 182u8, 67u8, 232u8, 9u8, 158u8, 34u8, 88u8, 40u8,
								137u8, 86u8,
							],
						)
					}
	...
	pub mod bridge_relayers {
		...
		pub mod calls {
			...
			pub mod claim_rewards {
				use super::runtime_types;
				pub type RewardKind =
					runtime_types::bridge_hub_westend_runtime::bridge_common_config::BridgeReward;
			}
			impl ClaimRewards {
			...
			pub mod claim_rewards_to {
				...
				pub type RewardKind =
					runtime_types::bridge_hub_westend_runtime::bridge_common_config::BridgeReward;
				pub type Beneficiary = runtime_types::bridge_hub_westend_runtime::bridge_common_config::BridgeRewardBeneficiaries;
			}
			impl ClaimRewardsTo {
				const PALLET_NAME: &'static str = "BridgeRelayers";
				...
				impl TransactionApi {
					pub fn claim_rewards(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								196u8, 185u8, 106u8, 216u8, 223u8, 206u8, 115u8, 183u8, 90u8, 53u8,
								249u8, 92u8, 221u8, 42u8, 193u8, 18u8, 207u8, 76u8, 125u8, 163u8,
								5u8, 160u8, 164u8, 65u8, 159u8, 239u8, 132u8, 163u8, 38u8, 240u8,
								245u8, 63u8,
							],
						)
					}
					...
					pub fn claim_rewards_to(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								15u8, 151u8, 42u8, 123u8, 235u8, 234u8, 1u8, 66u8, 113u8, 19u8,
								43u8, 194u8, 202u8, 171u8, 148u8, 221u8, 189u8, 232u8, 222u8,
								145u8, 131u8, 43u8, 13u8, 117u8, 14u8, 145u8, 167u8, 16u8, 157u8,
								9u8, 13u8, 100u8,
							],
						)
					}
		...
		pub mod storage {
			...
			impl StorageApi {
				...
				> {
					::subxt::storage::StaticAddress::new_static(
						...
						"RelayerRewards",
						[
							236u8, 104u8, 133u8, 37u8, 193u8, 16u8, 107u8, 28u8, 1u8, 243u8, 102u8,
							96u8, 242u8, 41u8, 245u8, 243u8, 36u8, 229u8, 32u8, 163u8, 177u8,
							255u8, 11u8, 101u8, 122u8, 120u8, 150u8, 178u8, 54u8, 186u8, 13u8, 3u8,
						],
					)
				}
			...
			pub mod relayer_rewards {
				...
				pub mod input {
					use super::runtime_types;
					pub type Param0 = ::subxt::utils::AccountId32;
					pub type Param1 = runtime_types::bridge_hub_westend_runtime::bridge_common_config::BridgeReward;
				}
				pub type Output = ::core::primitive::u128;
			}
	...
	pub mod bridge_rococo_grandpa {
		...
		pub mod calls {
			...
			impl SubmitFinalityProof {
				const PALLET_NAME: &'static str = "BridgeRococoGrandpa";
	...
	pub mod bridge_rococo_parachains {
		...
		pub mod calls {
			...
			impl SubmitParachainHeads {
				const PALLET_NAME: &'static str = "BridgeRococoParachains";
	...
	pub mod bridge_rococo_messages {
		...
		pub mod calls {
			...
			impl SetOwner {
				const PALLET_NAME: &'static str = "BridgeRococoMessages";
				const CALL_NAME: &'static str = "set_owner";
			}
			impl ::subxt::extrinsics::DecodeAsExtrinsic for SetOwner {
				fn is_extrinsic(pallet_name: &str, call_name: &str) -> bool {
	...
	pub mod xcm_over_bridge_hub_rococo {
		use super::{root_mod, runtime_types};
		...
		pub mod calls {
			...
			impl OpenBridge {
				const PALLET_NAME: &'static str = "XcmOverBridgeHubRococo";
			...
			impl StorageApi {
				...
				> {
					::subxt::storage::StaticAddress::new_static(
						...
						"PricingParameters",
						[
							57u8, 147u8, 102u8, 110u8, 152u8, 63u8, 200u8, 18u8, 26u8, 124u8,
							185u8, 203u8, 199u8, 254u8, 159u8, 116u8, 147u8, 26u8, 40u8, 182u8,
							231u8, 251u8, 69u8, 29u8, 237u8, 233u8, 8u8, 42u8, 253u8, 72u8, 50u8,
							140u8,
						],
					)
				}
			...
			impl ConstantsApi {
				...
				> {
					::subxt::constants::StaticAddress::new_static(
						...
						"DefaultRewardKind",
						[
							242u8, 102u8, 171u8, 136u8, 106u8, 47u8, 216u8, 165u8, 228u8, 51u8,
							245u8, 165u8, 131u8, 51u8, 83u8, 127u8, 170u8, 249u8, 232u8, 127u8,
							174u8, 124u8, 32u8, 239u8, 127u8, 187u8, 144u8, 14u8, 3u8, 157u8, 56u8,
							54u8,
						],
					)
				}
	...
	pub mod runtime_types {
		...
		pub mod bridge_hub_westend_runtime {
			...
			pub mod bridge_common_config {
				...
				pub enum BridgeRewardBeneficiaries {
					...
					#[codec(index = 1)]
					AssetHubLocation(runtime_types::xcm::VersionedLocation),
				}
			}
			#[derive(
				::subxt::ext::scale_decode::DecodeAsType,
			...
			pub enum RuntimeCall {
				...
				#[codec(index = 45)]
				XcmOverBridgeHubRococo(runtime_types::pallet_xcm_bridge_hub::pallet::Call),
				#[codec(index = 80)]
			...
			pub enum RuntimeError {
				...
				#[codec(index = 45)]
				XcmOverBridgeHubRococo(runtime_types::pallet_xcm_bridge_hub::pallet::Error),
				#[codec(index = 80)]
			...
			pub enum RuntimeEvent {
				...
				#[codec(index = 12)]
				AccumulateForward(runtime_types::pallet_accumulate_and_forward::pallet::Event),
				#[codec(index = 21)]
				...
				#[codec(index = 45)]
				XcmOverBridgeHubRococo(runtime_types::pallet_xcm_bridge_hub::pallet::Event),
				#[codec(index = 80)]
			...
			pub enum RuntimeHoldReason {
				...
				#[codec(index = 45)]
				XcmOverBridgeHubRococo(runtime_types::pallet_xcm_bridge_hub::pallet::HoldReason),
			}
			#[derive(
				::subxt::ext::scale_decode::DecodeAsType,
				::subxt::ext::scale_encode::EncodeAsType,
		...
		pub mod pallet_accumulate_and_forward {
			...
			pub mod pallet {
				...
				pub enum Event {
					#[codec(index = 0)]
					ForwardSucceeded { amount: ::core::primitive::u128 },
					#[codec(index = 1)]
					ForwardFailed { amount: ::core::primitive::u128 },
				}
			}
		}
		pub mod pallet_balances {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					#[codec(index = 24)]
					Held {
						reason: runtime_types::bridge_hub_westend_runtime::RuntimeHoldReason,
		...
		pub mod pallet_bridge_relayers {
			...
			pub mod pallet {
				...
				pub enum Call {
					#[codec(index = 0)]
                    claim_rewards {
                        reward_kind: runtime_types::bridge_hub_westend_runtime::bridge_common_config::BridgeReward,
                    },
                    #[codec(index = 1)]
                    ...
                    claim_rewards_to {
                        reward_kind: runtime_types::bridge_hub_westend_runtime::bridge_common_config::BridgeReward,
                        beneficiary: runtime_types::bridge_hub_westend_runtime::bridge_common_config::BridgeRewardBeneficiaries,
                    },
                }
				#[derive(
					::subxt::ext::scale_decode::DecodeAsType,
