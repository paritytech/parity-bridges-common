...
//! /tmp/tmp.IJqS3hfaGc/bridge-hub-kusama_runtime-v2003002.compact.compressed.wasm
...
pub mod api {
	...
	pub type Event = runtime_types::bridge_hub_kusama_runtime::RuntimeEvent;
	/// The outer extrinsic enum.
	pub type Call = runtime_types::bridge_hub_kusama_runtime::RuntimeCall;
	/// The outer error enum represents the DispatchError's Module variant.
	pub type Error = runtime_types::bridge_hub_kusama_runtime::RuntimeError;
	...
	impl ConstantsApi {
		...
		pub fn bridge_polkadot_grandpa(&self) -> bridge_polkadot_grandpa::constants::ConstantsApi {
			bridge_polkadot_grandpa::constants::ConstantsApi
		}
		pub fn bridge_polkadot_parachains(
			&self,
		) -> bridge_polkadot_parachains::constants::ConstantsApi {
			bridge_polkadot_parachains::constants::ConstantsApi
		}
		pub fn xcm_over_bridge_hub_polkadot(
			&self,
		) -> xcm_over_bridge_hub_polkadot::constants::ConstantsApi {
			xcm_over_bridge_hub_polkadot::constants::ConstantsApi
		}
	...
	impl StorageApi {
		...
		pub fn bridge_polkadot_grandpa(&self) -> bridge_polkadot_grandpa::storage::StorageApi {
			bridge_polkadot_grandpa::storage::StorageApi
		}
		pub fn bridge_polkadot_parachains(
			&self,
		) -> bridge_polkadot_parachains::storage::StorageApi {
			bridge_polkadot_parachains::storage::StorageApi
		}
		pub fn bridge_polkadot_messages(&self) -> bridge_polkadot_messages::storage::StorageApi {
			bridge_polkadot_messages::storage::StorageApi
		}
		pub fn xcm_over_bridge_hub_polkadot(
			&self,
		) -> xcm_over_bridge_hub_polkadot::storage::StorageApi {
			xcm_over_bridge_hub_polkadot::storage::StorageApi
		}
	...
	impl TransactionApi {
		...
		pub fn bridge_polkadot_grandpa(
			&self,
		) -> bridge_polkadot_grandpa::calls::api::TransactionApi {
			bridge_polkadot_grandpa::calls::api::TransactionApi
		}
		pub fn bridge_polkadot_parachains(
			&self,
		) -> bridge_polkadot_parachains::calls::api::TransactionApi {
			bridge_polkadot_parachains::calls::api::TransactionApi
		}
		pub fn bridge_polkadot_messages(
			&self,
		) -> bridge_polkadot_messages::calls::api::TransactionApi {
			bridge_polkadot_messages::calls::api::TransactionApi
		}
		pub fn xcm_over_bridge_hub_polkadot(
			&self,
		) -> xcm_over_bridge_hub_polkadot::calls::api::TransactionApi {
			xcm_over_bridge_hub_polkadot::calls::api::TransactionApi
		}
	...
	pub fn is_codegen_valid_for(metadata: &::subxt::Metadata) -> bool {
		...
		runtime_metadata_hash ==
			[
				44u8, 100u8, 139u8, 123u8, 33u8, 190u8, 197u8, 148u8, 61u8, 175u8, 160u8, 143u8,
				230u8, 180u8, 225u8, 219u8, 55u8, 80u8, 53u8, 156u8, 100u8, 80u8, 84u8, 12u8, 33u8,
				43u8, 201u8, 237u8, 223u8, 42u8, 204u8, 179u8,
			]
	}
	pub mod system {
		use super::{root_mod, runtime_types};
			...
			impl StorageApi {
				...
				pub fn events(
					...
					::subxt::storage::StaticAddress::new_static(
						...
						"Events",
						[
							224u8, 199u8, 135u8, 70u8, 114u8, 189u8, 155u8, 209u8, 100u8, 101u8,
							123u8, 29u8, 13u8, 40u8, 71u8, 187u8, 169u8, 81u8, 214u8, 205u8, 206u8,
							146u8, 47u8, 7u8, 211u8, 248u8, 34u8, 210u8, 134u8, 48u8, 120u8, 15u8,
						],
					)
				}
				pub fn event_count(
			...
			pub mod events {
				...
				pub type Output = ::subxt::alloc::vec::Vec<
					runtime_types::frame_system::EventRecord<
						runtime_types::bridge_hub_kusama_runtime::RuntimeEvent,
						::subxt::utils::H256,
					>,
				>;
			}
	...
	pub mod balances {
		...
		pub mod events {
			...
			pub mod held {
				use super::runtime_types;
				pub type Reason = runtime_types::bridge_hub_kusama_runtime::RuntimeHoldReason;
				pub type Who = ::subxt::utils::AccountId32;
				pub type Amount = ::core::primitive::u128;
			}
			impl Held {
			...
			impl StorageApi {
				...
				> {
					::subxt::storage::StaticAddress::new_static(
						...
						"Holds",
						[
							209u8, 241u8, 222u8, 132u8, 145u8, 57u8, 99u8, 237u8, 232u8, 208u8,
							149u8, 62u8, 35u8, 246u8, 126u8, 154u8, 159u8, 92u8, 131u8, 172u8,
							229u8, 46u8, 17u8, 179u8, 175u8, 136u8, 90u8, 181u8, 214u8, 188u8,
							222u8, 80u8,
						],
					)
				}
			...
			pub mod holds {
				...
				pub type Output = runtime_types::bounded_collections::bounded_vec::BoundedVec<
					runtime_types::frame_support::traits::tokens::misc::IdAmount<
						runtime_types::bridge_hub_kusama_runtime::RuntimeHoldReason,
						::core::primitive::u128,
					>,
				>;
			}
	...
	pub mod session {
		...
		pub mod calls {
			...
			pub mod set_keys {
				use super::runtime_types;
				pub type Keys = runtime_types::bridge_hub_kusama_runtime::SessionKeys;
		...
		pub mod storage {
			...
			pub mod queued_keys {
				...
				pub type Output = ::subxt::alloc::vec::Vec<(
					::subxt::utils::AccountId32,
					runtime_types::bridge_hub_kusama_runtime::SessionKeys,
				)>;
			}
			...
			pub mod next_keys {
				...
				pub type Output = runtime_types::bridge_hub_kusama_runtime::SessionKeys;
			}
			pub mod key_owner {
				use super::{root_mod, runtime_types};
				pub mod input {
	...
	pub mod utility {
		...
		pub mod calls {
			...
			pub mod batch {
				use super::runtime_types;
				pub type Calls =
					::subxt::alloc::vec::Vec<runtime_types::bridge_hub_kusama_runtime::RuntimeCall>;
			}
			impl Batch {
			...
			pub mod dispatch_as {
				use super::runtime_types;
				pub type AsOrigin = runtime_types::bridge_hub_kusama_runtime::OriginCaller;
				pub type Call = runtime_types::bridge_hub_kusama_runtime::RuntimeCall;
			}
			impl DispatchAs {
				const PALLET_NAME: &'static str = "Utility";
			...
			pub mod if_else {
				use super::runtime_types;
				pub type Main = runtime_types::bridge_hub_kusama_runtime::RuntimeCall;
				pub type Fallback = runtime_types::bridge_hub_kusama_runtime::RuntimeCall;
			}
			impl IfElse {
				const PALLET_NAME: &'static str = "Utility";
				...
				impl TransactionApi {
					pub fn batch(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							super::Batch { calls },
							[
								97u8, 61u8, 235u8, 212u8, 84u8, 172u8, 205u8, 189u8, 77u8, 116u8,
								40u8, 31u8, 155u8, 12u8, 80u8, 73u8, 36u8, 170u8, 6u8, 51u8, 51u8,
								51u8, 160u8, 48u8, 186u8, 97u8, 230u8, 117u8, 109u8, 129u8, 72u8,
								239u8,
							],
						)
					}
					pub fn as_derivative(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								99u8, 35u8, 222u8, 205u8, 127u8, 239u8, 169u8, 67u8, 239u8, 151u8,
								201u8, 40u8, 213u8, 66u8, 27u8, 90u8, 249u8, 57u8, 192u8, 220u8,
								145u8, 231u8, 86u8, 194u8, 46u8, 38u8, 165u8, 129u8, 7u8, 161u8,
								188u8, 210u8,
							],
						)
					}
					pub fn batch_all(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								230u8, 162u8, 137u8, 201u8, 135u8, 252u8, 102u8, 48u8, 189u8,
								251u8, 110u8, 255u8, 58u8, 250u8, 42u8, 59u8, 55u8, 133u8, 59u8,
								210u8, 110u8, 191u8, 27u8, 131u8, 167u8, 109u8, 222u8, 181u8,
								241u8, 170u8, 96u8, 191u8,
							],
						)
					}
					pub fn dispatch_as(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								120u8, 177u8, 21u8, 163u8, 174u8, 148u8, 171u8, 33u8, 34u8, 36u8,
								253u8, 123u8, 159u8, 80u8, 128u8, 25u8, 4u8, 2u8, 19u8, 248u8,
								216u8, 17u8, 225u8, 141u8, 253u8, 230u8, 207u8, 174u8, 178u8, 14u8,
								114u8, 55u8,
							],
						)
					}
					pub fn force_batch(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								105u8, 130u8, 167u8, 219u8, 245u8, 16u8, 242u8, 39u8, 52u8, 227u8,
								120u8, 191u8, 217u8, 185u8, 119u8, 71u8, 50u8, 223u8, 67u8, 221u8,
								74u8, 37u8, 186u8, 32u8, 29u8, 132u8, 141u8, 166u8, 178u8, 222u8,
								63u8, 181u8,
							],
						)
					}
					pub fn with_weight(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								177u8, 14u8, 40u8, 130u8, 28u8, 166u8, 159u8, 142u8, 173u8, 199u8,
								140u8, 79u8, 79u8, 99u8, 27u8, 116u8, 5u8, 2u8, 225u8, 246u8, 46u8,
								178u8, 163u8, 54u8, 165u8, 102u8, 64u8, 139u8, 230u8, 164u8, 81u8,
								228u8,
							],
						)
					}
					pub fn if_else(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								213u8, 170u8, 131u8, 175u8, 8u8, 249u8, 82u8, 68u8, 234u8, 47u8,
								146u8, 8u8, 61u8, 17u8, 130u8, 83u8, 153u8, 185u8, 242u8, 54u8,
								248u8, 175u8, 41u8, 177u8, 173u8, 164u8, 165u8, 64u8, 11u8, 253u8,
								50u8, 229u8,
							],
						)
					}
					pub fn dispatch_as_fallible(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								215u8, 180u8, 49u8, 50u8, 217u8, 18u8, 69u8, 58u8, 38u8, 47u8,
								248u8, 119u8, 231u8, 184u8, 5u8, 166u8, 209u8, 124u8, 32u8, 160u8,
								163u8, 92u8, 167u8, 39u8, 239u8, 98u8, 93u8, 64u8, 164u8, 186u8,
								64u8, 207u8,
							],
						)
					}
				...
				impl TransactionApi {
					pub fn as_multi_threshold_1(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								47u8, 135u8, 49u8, 10u8, 110u8, 39u8, 81u8, 185u8, 34u8, 159u8,
								215u8, 39u8, 30u8, 135u8, 107u8, 25u8, 56u8, 205u8, 226u8, 138u8,
								195u8, 53u8, 42u8, 91u8, 37u8, 79u8, 205u8, 78u8, 219u8, 57u8,
								14u8, 227u8,
							],
						)
					}
					pub fn as_multi(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								101u8, 118u8, 212u8, 93u8, 138u8, 120u8, 254u8, 64u8, 170u8, 36u8,
								124u8, 156u8, 11u8, 1u8, 3u8, 246u8, 181u8, 130u8, 60u8, 88u8,
								50u8, 74u8, 71u8, 137u8, 120u8, 63u8, 80u8, 106u8, 107u8, 200u8,
								171u8, 165u8,
							],
						)
					}
		...
		pub mod calls {
			...
			pub mod proxy {
				...
				pub type ForceProxyType =
					::core::option::Option<runtime_types::bridge_hub_kusama_runtime::ProxyType>;
				pub type Call = runtime_types::bridge_hub_kusama_runtime::RuntimeCall;
			}
			impl Proxy {
			...
			pub mod add_proxy {
				...
				pub type ProxyType = runtime_types::bridge_hub_kusama_runtime::ProxyType;
				...
				impl TransactionApi {
					pub fn proxy(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								152u8, 203u8, 108u8, 206u8, 217u8, 167u8, 183u8, 74u8, 56u8, 249u8,
								171u8, 1u8, 142u8, 31u8, 241u8, 52u8, 235u8, 171u8, 31u8, 72u8,
								2u8, 194u8, 63u8, 34u8, 255u8, 80u8, 221u8, 175u8, 21u8, 197u8,
								194u8, 165u8,
							],
						)
					}
					...
					pub fn proxy_announced(
						...
						::subxt::transactions::StaticPayload::new_static(
							...
							[
								144u8, 160u8, 94u8, 47u8, 96u8, 121u8, 85u8, 121u8, 115u8, 148u8,
								167u8, 196u8, 155u8, 147u8, 196u8, 4u8, 129u8, 208u8, 231u8, 73u8,
								67u8, 241u8, 60u8, 1u8, 146u8, 162u8, 14u8, 147u8, 231u8, 232u8,
								214u8, 106u8,
							],
						)
					}
				...
				pub type Output = (
					runtime_types::bounded_collections::bounded_vec::BoundedVec<
						runtime_types::pallet_proxy::ProxyDefinition<
							::subxt::utils::AccountId32,
							runtime_types::bridge_hub_kusama_runtime::ProxyType,
							::core::primitive::u32,
						>,
					>,
					::core::primitive::u128,
	...
	pub mod bridge_polkadot_grandpa {
		...
		pub mod calls {
			...
			impl SubmitFinalityProof {
				const PALLET_NAME: &'static str = "BridgePolkadotGrandpa";
	...
	pub mod bridge_polkadot_parachains {
		...
		pub mod calls {
			...
			impl SubmitParachainHeads {
				const PALLET_NAME: &'static str = "BridgePolkadotParachains";
	...
	pub mod bridge_polkadot_messages {
		...
		pub mod calls {
			...
			impl SetOwner {
				const PALLET_NAME: &'static str = "BridgePolkadotMessages";
				const CALL_NAME: &'static str = "set_owner";
			}
			impl ::subxt::extrinsics::DecodeAsExtrinsic for SetOwner {
				fn is_extrinsic(pallet_name: &str, call_name: &str) -> bool {
	...
	pub mod xcm_over_bridge_hub_polkadot {
		use super::{root_mod, runtime_types};
		...
		pub mod calls {
			...
			impl OpenBridge {
				const PALLET_NAME: &'static str = "XcmOverBridgeHubPolkadot";
	...
	pub mod runtime_types {
		...
		pub mod bridge_hub_kusama_runtime {
			...
			pub enum RuntimeCall {
				...
				#[codec(index = 54)]
				XcmOverBridgeHubPolkadot(runtime_types::pallet_xcm_bridge_hub::pallet::Call),
				#[codec(index = 175)]
			...
			pub enum RuntimeError {
				...
				#[codec(index = 54)]
				XcmOverBridgeHubPolkadot(runtime_types::pallet_xcm_bridge_hub::pallet::Error),
				#[codec(index = 175)]
			...
			pub enum RuntimeEvent {
				...
				#[codec(index = 54)]
				XcmOverBridgeHubPolkadot(runtime_types::pallet_xcm_bridge_hub::pallet::Event),
				#[codec(index = 175)]
			...
			pub enum RuntimeHoldReason {
				...
				#[codec(index = 54)]
				XcmOverBridgeHubPolkadot(runtime_types::pallet_xcm_bridge_hub::pallet::HoldReason),
			}
			#[derive(
				::subxt::ext::scale_decode::DecodeAsType,
				::subxt::ext::scale_encode::EncodeAsType,
		...
		pub mod pallet_balances {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					#[codec(index = 24)]
					Held {
						reason: runtime_types::bridge_hub_kusama_runtime::RuntimeHoldReason,
				...
				pub enum Call {
					...
					as_multi_threshold_1 {
						...
						call: ::subxt::alloc::boxed::Box<
							runtime_types::bridge_hub_kusama_runtime::RuntimeCall,
						>,
					},
					#[codec(index = 1)]
					as_multi {
			...
			pub mod pallet {
				...
				pub enum Call {
					...
					add_proxy {
						...
						proxy_type: runtime_types::bridge_hub_kusama_runtime::ProxyType,
		...
		pub mod pallet_session {
			...
			pub mod pallet {
				...
				pub enum Call {
					#[codec(index = 0)]
					set_keys {
						keys: runtime_types::bridge_hub_kusama_runtime::SessionKeys,
				...
				pub enum Call {
					...
					dispatch_as {
						as_origin: ::subxt::alloc::boxed::Box<
							runtime_types::bridge_hub_kusama_runtime::OriginCaller,
						>,
						call: ::subxt::alloc::boxed::Box<
							runtime_types::bridge_hub_kusama_runtime::RuntimeCall,
						>,
