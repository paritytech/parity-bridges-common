...
pub const MAXIMUM_BLOCK_WEIGHT: Weight =
	Weight::from_ref_time(constants::WEIGHT_REF_TIME_PER_SECOND)
...
parameter_types! {
	...
	pub const BlockExecutionWeight: Weight = Weight::from_ref_time(constants::WEIGHT_REF_TIME_PER_SECOND).saturating_mul(5_000_000);

	pub const ExtrinsicBaseWeight: Weight = Weight::from_ref_time(constants::WEIGHT_REF_TIME_PER_SECOND).saturating_mul(125_000);
