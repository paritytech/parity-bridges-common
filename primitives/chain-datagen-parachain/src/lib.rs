...
pub const DATAGEN_PARACHAIN_ID: u32 = 1000;//2000;
...
impl Chain for DatagenParachain {
	...
	fn max_extrinsic_weight() -> Weight {
		BlockWeights::get().get(DispatchClass::Normal)
		.max_extrinsic
...
pub const WITH_DATAGEN_PARACHAIN_MESSAGES_PALLET_NAME: &str = "BridgeRialtoParachainMessages";
...
decl_bridge_runtime_apis!(datagen_parachain);