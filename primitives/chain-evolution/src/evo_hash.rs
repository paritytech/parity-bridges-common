...
fixed_hash::construct_fixed_hash! {
    /// Hash type used in Evolution chain.
    #[derive(MallocSizeOf, TypeInfo)]
    pub struct EvoHash(64);
}

impl_serde::impl_fixed_hash_serde!(EvoHash, 64);
impl_codec::impl_fixed_hash_codec!(EvoHash, 64);

impl CheckEqual for EvoHash {
    #[cfg(feature = "std")]
