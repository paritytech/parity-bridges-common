...
mod tests {
	...
	fn transfer_transaction_decode_works() {
		...
		let raw_tx = hex!(
			"f86c0a85046c7cfe0083016dea94d1310c1e038bc12865d3d3997275b3e4737c6302880b503be34d9fe80080269fc7eaaa9c21f59adf8ad43ed66cf5ef9ee1c317bd4d32cd65401e7aaca47cfaa0387d79c65b90be6260d09dcfb780f29dd8133b9b1ceb20b83b7e442b4bfc30cb"
		);
		assert_eq!(
		...
		let raw_tx = hex!(
			"f86a822816808252089470c1ccde719d6f477084f07e4137ab0e55f8369f8930cf46e92063afd8008078a00e4d1f4d8aa992bda3c105ff3d6e9b9acbfd99facea00985e2131029290adbdca028ea29a46a4b66ec65b454f0706228e3768cb0ecf755f67c50ddd472f11d5994"
		);
		assert_eq!(
			transaction_decode_rlp(&raw_tx),
			Ok(Transaction {
	...
	fn payload_transaction_decode_works() {
		...
		let raw_tx = hex!(
			""
		);
		assert_eq!(
			transaction_decode_rlp(&raw_tx),
			Ok(Transaction {
		...
		let raw_tx = hex!(
			""
		);
		assert_eq!(
			transaction_decode_rlp(&raw_tx),
			Ok(Transaction {
