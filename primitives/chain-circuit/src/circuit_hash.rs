...
fixed_hash::construct_fixed_hash! {
	...
	#[derive(MallocSizeOf)]
	pub struct CircuitHash(64);
}

#[cfg(feature = "std")]
impl_serde::impl_fixed_hash_serde!(CircuitHash, 64);

impl_codec::impl_fixed_hash_codec!(CircuitHash, 64);

impl CheckEqual for CircuitHash {
	#[cfg(feature = "std")]
