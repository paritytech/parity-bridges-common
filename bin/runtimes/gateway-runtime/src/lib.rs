...
pub type WithCircuitMessagesInstance = pallet_bridge_messages::DefaultInstance;
...
construct_runtime!(
	...
	{
		BridgeGatewayPoA: pallet_bridge_eth_poa::<Instance1>::{Pallet, Call, Config, Storage, ValidateUnsigned},
		BridgeKovan: pallet_bridge_eth_poa::<Instance2>::{Pallet, Call, Config, Storage, ValidateUnsigned},
		BridgeGatewayCurrencyExchange: pallet_bridge_currency_exchange::<Instance1>::{Pallet, Call},
		BridgeKovanCurrencyExchange: pallet_bridge_currency_exchange::<Instance2>::{Pallet, Call},
		BridgeCircuitGrandpa: pallet_bridge_grandpa::{Pallet, Call, Storage},
		BridgeDispatch: pallet_bridge_dispatch::{Pallet, Event<T>},
		BridgeCircuitMessages: pallet_bridge_messages::{Pallet, Call, Storage, Event<T>},
...
impl_runtime_apis! {
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		fn dispatch_benchmark(
			...
			add_benchmark!(params, batches, pallet_bridge_grandpa, BridgeCircuitGrandpa);
