...
sc_executor::native_executor_instance!(
	pub RelaltoExecutor,
	relalto_runtime::api::dispatch,
	relalto_runtime::native_version,
		...
		OverseerGenerator: OverseerGen,
{
	...
	let parachains_db = crate::service::parachains_db::open_creating(
		config.database.path().ok_or(Error::DatabasePathRequired)?.into(),
		crate::service::parachains_db::CacheSizes::default(),
	)?;

	let availability_config = AvailabilityConfig {
		col_data: crate::service::parachains_db::REAL_COLUMNS.col_availability_data,
		col_meta: crate::service::parachains_db::REAL_COLUMNS.col_availability_meta,
	};

	let approval_voting_config = ApprovalVotingConfig {
		col_data: crate::service::parachains_db::REAL_COLUMNS.col_approval_data,
