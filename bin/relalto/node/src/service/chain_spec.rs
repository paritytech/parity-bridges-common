...
fn testnet_genesis(
	...
	GenesisConfig {
		...
		babe: BabeConfig {
			authorities: Vec::new(),
			epoch_config: Some(relalto_runtime::BABE_GENESIS_EPOCH_CONFIG),
		},
...
fn load_rialto_poa_bridge_config() -> BridgeRialtoPoaConfig {
	BridgeRialtoPoaConfig {
		initial_header: relalto_runtime::rialto_poa::genesis_header(),
		initial_difficulty: 0.into(),
		initial_validators: relalto_runtime::rialto_poa::genesis_validators(),
	}
}

fn load_kovan_bridge_config() -> BridgeKovanConfig {
	BridgeKovanConfig {
		initial_header: relalto_runtime::kovan::genesis_header(),
		initial_difficulty: 0.into(),
		initial_validators: relalto_runtime::kovan::genesis_validators(),
	}
}
