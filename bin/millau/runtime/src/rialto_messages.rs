...
impl TargetHeaderChain<ToRialtoMessagePayload, bp_rialto::AccountId> for Rialto {
	...
	fn verify_messages_delivery_proof(
		...
		messages::source::verify_messages_delivery_proof::<WithRialtoMessageBridge, Runtime, crate::RialtoGrandpaInstance>(proof)
	}
}
...
impl SourceHeaderChain<bp_rialto::Balance> for Rialto {
	...
	fn verify_messages_proof(
		...
		messages::target::verify_messages_proof::<WithRialtoMessageBridge, Runtime, crate::RialtoGrandpaInstance>(proof, messages_count)
	}
}
