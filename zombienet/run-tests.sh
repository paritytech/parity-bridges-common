...
# Rococo and it parachains configuration
export ROCOCO_ALICE_HOST=localhost
export ROCOCO_ALICE_WS_PORT=9942
export ASSET_HUB_ROCOCO_ALICE_HOST=localhost
export ASSET_HUB_ROCOCO_ALICE_WS_PORT=9910
export BRIDGE_HUB_ROCOCO_ALICE_HOST=localhost
export BRIDGE_HUB_ROCOCO_ALICE_WS_PORT=8943

# Wococo and it parachains configuration
export WOCOCO_ALICE_HOST=localhost
export WOCOCO_ALICE_WS_PORT=9945
export ASSET_HUB_WOCOCO_ALICE_HOST=localhost
export ASSET_HUB_WOCOCO_ALICE_WS_PORT=9010
export BRIDGE_HUB_WOCOCO_ALICE_HOST=localhost
export BRIDGE_HUB_WOCOCO_ALICE_WS_PORT=8945
