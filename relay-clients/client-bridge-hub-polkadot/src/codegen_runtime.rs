...
//! ./tools/runtime-codegen/wbuild/bridge-hub-polkadot_runtime-v2005000.compact.compressed.wasm
	...
	pub mod runtime_types {
		...
		pub mod bp_xcm_bridge_hub {
			...
			pub struct Bridge {
				...
				pub bridge_owner_account: ::sp_core::crypto::AccountId32,
		...
		pub mod bridge_hub_polkadot_runtime {
			...
			pub mod bridge_common_config {
				...
				pub enum BridgeRewardBeneficiaries {
					#[codec(index = 0)]
					LocalAccount(::sp_core::crypto::AccountId32),
					#[codec(index = 1)]
					AssetHubLocation(
						::subxt::alloc::boxed::Box<runtime_types::xcm::VersionedLocation>,
					),
