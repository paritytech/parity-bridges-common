...
//! EXECUTED COMMAND: target/debug/runtime-codegen --from-wasm-file /Users/anthony/Downloads/bridge-hub-polkadot_runtime-v1004003.compact.compressed.wasm
    ...
    pub mod runtime_types {
        ...
        pub mod bridge_hub_polkadot_runtime {
            ...
            pub enum RuntimeCall {
                ...
                EthereumInboundQueue(
                    runtime_types::snowbridge_pallet_inbound_queue::pallet::Call,
                ),
                #[codec(index = 81)]
            ...
            pub enum RuntimeError {
                ...
                #[codec(index = 21)]
                CollatorSelection(
                    runtime_types::pallet_collator_selection::pallet::Error,
                ),
                #[codec(index = 22)]
                ...
                #[codec(index = 80)]
                EthereumInboundQueue(
                    runtime_types::snowbridge_pallet_inbound_queue::pallet::Error,
                ),
                #[codec(index = 81)]
                EthereumOutboundQueue(
            ...
            pub enum RuntimeEvent {
                ...
                #[codec(index = 80)]
                EthereumInboundQueue(
                    runtime_types::snowbridge_pallet_inbound_queue::pallet::Event,
                ),
                #[codec(index = 81)]
                EthereumOutboundQueue(
        ...
        pub mod cumulus_primitives_parachain_inherent {
            ...
            pub struct ParachainInherentData {
                pub validation_data: runtime_types::polkadot_primitives::v8::PersistedValidationData<
        ...
        pub mod pallet_bridge_relayers {
            ...
            pub mod extension {
                use super::runtime_types;
                #[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
                pub struct BridgeRelayersSignedExtension;
            }
            pub mod pallet {
                use super::runtime_types;
                #[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
        ...
        pub mod pallet_message_queue {
            ...
            pub mod pallet {
                ...
                pub enum Call {
                    #[codec(index = 0)]
                    reap_page {
                        message_origin: runtime_types::bridge_hub_common::message_queue::AggregateMessageOrigin,
                ...
                pub enum Event {
                    ...
                    ProcessingFailed {
                        ...
                        origin: runtime_types::bridge_hub_common::message_queue::AggregateMessageOrigin,
        ...
        pub mod polkadot_primitives {
            ...
            pub mod v8 {
                ...
                pub struct AbridgedHostConfiguration {
                    ...
                    pub async_backing_params: runtime_types::polkadot_primitives::v8::async_backing::AsyncBackingParams,
                }
                #[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
        ...
        pub mod snowbridge_beacon_primitives {
            ...
            pub mod types {
                ...
                pub mod deneb {
                    ...
                    pub struct ExecutionPayloadHeader {
                        ...
                        pub logs_bloom: ::subxt::ext::subxt_core::alloc::vec::Vec<
                            ::core::primitive::u8,
                        >,
                ...
                pub struct SyncAggregate {
                    ...
                    pub sync_committee_signature: runtime_types::snowbridge_beacon_primitives::types::Signature,
                }
                #[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
                pub struct SyncCommittee {
                    pub pubkeys: [runtime_types::snowbridge_beacon_primitives::types::PublicKey; 512usize],
                    pub aggregate_pubkey: runtime_types::snowbridge_beacon_primitives::types::PublicKey,
                }
                #[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
            ...
            pub mod updates {
                ...
                pub struct CheckpointUpdate {
                    pub header: runtime_types::snowbridge_beacon_primitives::types::BeaconHeader,
                    pub current_sync_committee: runtime_types::snowbridge_beacon_primitives::types::SyncCommittee,
                ...
                pub struct NextSyncCommitteeUpdate {
                    pub next_sync_committee: runtime_types::snowbridge_beacon_primitives::types::SyncCommittee,
        ...
        pub mod snowbridge_core {
            ...
            pub mod inbound {
                ...
                pub struct Proof {
                    ...
                    pub execution_proof: runtime_types::snowbridge_beacon_primitives::types::ExecutionProof,
                }
                #[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
                pub enum VerificationError {
                    #[codec(index = 0)]
            ...
            pub mod outbound {
                ...
                pub mod v1 {
                    ...
                    pub struct Initializer {
                        pub params: ::subxt::ext::subxt_core::alloc::vec::Vec<
                            ::core::primitive::u8,
                        >,
        ...
        pub mod snowbridge_pallet_inbound_queue {
            ...
            pub mod pallet {
                ...
                pub enum Error {
                    ...
                    #[codec(index = 8)]
                    Verification(
                        runtime_types::snowbridge_core::inbound::VerificationError,
                    ),
                    #[codec(index = 9)]
                    Send(
                        runtime_types::snowbridge_pallet_inbound_queue::pallet::SendError,
                    ),
                    #[codec(index = 10)]
                    ConvertMessage(
            ...
            pub mod pallet {
                ...
                pub enum Event {
                    ...
                    Upgrade {
                        impl_address: ::subxt::ext::subxt_core::utils::H160,
                        impl_code_hash: ::subxt::ext::subxt_core::utils::H256,
                        initializer_params_hash: ::core::option::Option<
                            ::subxt::ext::subxt_core::utils::H256,
                        >,
                    },
                    #[codec(index = 1)]
