...
pub mod api {
	...
	pub mod runtime_types {
		...
		pub mod kusama_runtime_constants {
			use super::runtime_types;
			pub mod proxy {
				use super::runtime_types;
				#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
		...
		pub mod pallet_balances {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					#[codec(index = 24)]
					Held {
						reason: runtime_types::staging_kusama_runtime::RuntimeHoldReason,
						who: ::sp_core::crypto::AccountId32,
						amount: ::core::primitive::u128,
					},
					#[codec(index = 25)]
			...
			pub mod pallet {
				...
				pub enum Call {
					...
					propose_bounty {
						#[codec(compact)]
						value: ::core::primitive::u128,
						description: ::subxt::alloc::vec::Vec<::core::primitive::u8>,
					},
					#[codec(index = 1)]
					approve_bounty {
						#[codec(compact)]
		...
		pub mod pallet_election_provider_multi_phase {
			...
			pub mod pallet {
				...
				pub enum Call {
					#[codec(index = 0)]
                    submit_unsigned {
                        raw_solution: ::subxt::alloc::boxed::Box<
			...
			pub struct ReadySolution {
				pub supports: runtime_types::frame_election_provider_support::BoundedSupports<
					::sp_core::crypto::AccountId32,
				>,
				pub score: runtime_types::sp_npos_elections::ElectionScore,
			...
			pub struct RoundSnapshot<_0, _1> {
				pub voters: ::subxt::alloc::vec::Vec<_1>,
				pub targets: ::subxt::alloc::vec::Vec<_0>,
			}
			#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
		...
		pub mod pallet_fast_unstake {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					#[codec(index = 2)]
					BatchChecked { eras: ::subxt::alloc::vec::Vec<::core::primitive::u32> },
					#[codec(index = 3)]
		...
		pub mod pallet_parameters {
			...
			pub mod pallet {
				...
				pub enum Call {
					#[codec(index = 0)]
					set_parameter {
						key_value: runtime_types::staging_kusama_runtime::RuntimeParameters,
					},
				}
				#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
				pub enum Event {
					#[codec(index = 0)]
					Updated {
						key: runtime_types::staging_kusama_runtime::RuntimeParametersKey,
						old_value: ::core::option::Option<
							runtime_types::staging_kusama_runtime::RuntimeParametersValue,
						>,
				...
				pub enum Call {
					...
					proxy {
						...
						force_proxy_type: ::core::option::Option<
							runtime_types::kusama_runtime_constants::proxy::ProxyType,
						>,
						call: ::subxt::alloc::boxed::Box<
							runtime_types::staging_kusama_runtime::RuntimeCall,
						>,
					...
					add_proxy {
						...
						proxy_type: runtime_types::kusama_runtime_constants::proxy::ProxyType,
						delay: ::core::primitive::u32,
					},
					#[codec(index = 2)]
					remove_proxy {
		...
		pub mod pallet_ranked_collective {
			...
			pub mod pallet {
				...
				pub enum Call {
					...
					exchange_member {
						who: ::subxt::utils::MultiAddress<::sp_core::crypto::AccountId32, ()>,
						new_who: ::subxt::utils::MultiAddress<::sp_core::crypto::AccountId32, ()>,
					},
				}
				#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
				pub enum Error {
				...
				pub enum Event {
					...
					MemberExchanged {
						who: ::sp_core::crypto::AccountId32,
						new_who: ::sp_core::crypto::AccountId32,
					},
				}
			}
			#[derive(
		...
		pub mod pallet_rc_migrator {
			...
			#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
			pub enum AccountState<_0> {
				#[codec(index = 0)]
				Migrate,
				#[codec(index = 1)]
				Preserve,
				#[codec(index = 2)]
				Part { free: _0, reserved: _0, consumers: ::core::primitive::u32 },
			}
		}
			...
			pub mod pallet {
				...
				pub enum Call {
					...
					found_society {
						...
						rules: ::subxt::alloc::vec::Vec<::core::primitive::u8>,
					},
					#[codec(index = 9)]
					dissolve,
					#[codec(index = 10)]
					...
					claim_membership,
					#[codec(index = 14)]
					bestow_membership { candidate: ::sp_core::crypto::AccountId32 },
					#[codec(index = 15)]
					kick_candidate { candidate: ::sp_core::crypto::AccountId32 },
					#[codec(index = 16)]
					resign_candidacy,
					#[codec(index = 17)]
					drop_candidate { candidate: ::sp_core::crypto::AccountId32 },
					#[codec(index = 18)]
					cleanup_candidacy {
				...
				pub enum Event {
					...
					Inducted {
						...
						candidates: ::subxt::alloc::vec::Vec<::sp_core::crypto::AccountId32>,
					},
					#[codec(index = 7)]
		...
		pub mod pallet_staking {
				...
				pub mod pallet {
					...
					pub enum Call {
						...
						cancel_deferred_slash {
							era: ::core::primitive::u32,
							slash_indices: ::subxt::alloc::vec::Vec<::core::primitive::u32>,
						},
						#[codec(index = 18)]
						payout_stakers {
						...
						manual_slash {
							validator_stash: ::sp_core::crypto::AccountId32,
							era: ::core::primitive::u32,
							slash_fraction: runtime_types::sp_arithmetic::per_things::Perbill,
						},
					}
					#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
					pub enum ConfigOp<_0> {
			...
			pub mod slashing {
				...
				pub struct SlashingSpans {
					...
					pub prior: ::subxt::alloc::vec::Vec<::core::primitive::u32>,
				}
				#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
			...
			pub struct UnappliedSlash<_0, _1> {
				pub validator: _0,
				pub own: _1,
				pub others: ::subxt::alloc::vec::Vec<(_0, _1)>,
		...
		pub mod pallet_staking_async_ah_client {
			use super::runtime_types;
			pub mod pallet {
				use super::runtime_types;
				#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
				pub enum Call {
					#[codec(index = 0)]
					validator_set {
						report: runtime_types::pallet_staking_async_rc_client::ValidatorSetReport<
							::sp_core::crypto::AccountId32,
						>,
					},
					#[codec(index = 1)]
					set_mode { mode: runtime_types::pallet_staking_async_ah_client::OperatingMode },
					#[codec(index = 2)]
					...
					#[codec(index = 4)]
					purge_keys_from_ah { stash: ::sp_core::crypto::AccountId32 },
				}
				#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
				pub enum Error {
					#[codec(index = 0)]
				...
				pub enum Event {
                    ...
                    ValidatorSetReceived {
                        ...
                        new_validator_set_count: ::core::primitive::u32,
                        prune_up_to: ::core::option::Option<::core::primitive::u32>,
                    ...
                    #[codec(index = 3)]
                    Unexpected(
                        runtime_types::pallet_staking_async_ah_client::pallet::UnexpectedKind,
                    ),
                    #[codec(index = 4)]
                    SessionKeysUpdated {
                        stash: ::sp_core::crypto::AccountId32,
                        update: runtime_types::pallet_staking_async_ah_client::pallet::SessionKeysUpdate,
                    },
                    #[codec(index = 5)]
		...
		pub mod polkadot_parachain_primitives {
			...
			pub mod primitives {
				...
				#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
				pub struct ValidationCode(pub ::subxt::alloc::vec::Vec<::core::primitive::u8>);
				#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
			...
			pub mod v9 {
				...
				pub mod executor_params {
					...
					pub enum ExecutorParam {
                        ...
                        #[codec(index = 8)]
                        EnabledHostFunction(
                            runtime_types::polkadot_primitives::v9::executor_params::ExecutorHostFunction,
                        ),
                    }
					#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
					pub struct ExecutorParams(
						pub  ::subxt::alloc::vec::Vec<
				...
				pub struct BackedCandidate<_0> {
					...
					pub validity_votes: ::subxt::alloc::vec::Vec<
				...
				#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
				pub struct CandidateDescriptorV2<_0> {
                    pub para_id: runtime_types::polkadot_parachain_primitives::primitives::Id,
                    pub relay_parent: _0,
                    pub version: ::core::primitive::u8,
                    pub core_index: ::core::primitive::u16,
                    pub session_index: ::core::primitive::u32,
                    pub scheduling_session_offset: ::core::primitive::u8,
                    pub reserved1: [::core::primitive::u8; 24usize],
                    ...
                    pub reserved2: [::core::primitive::u8; 32usize],
				...
				pub struct DisputeStatementSet {
					...
					pub statements: ::subxt::alloc::vec::Vec<(
				...
				pub struct SessionInfo {
					pub active_validator_indices: ::subxt::alloc::vec::Vec<
						runtime_types::polkadot_primitives::v9::ValidatorIndex,
					>,
					...
					pub validators: runtime_types::polkadot_primitives::v9::IndexedVec<
						...
						runtime_types::polkadot_primitives::v9::validator_app::Public,
					>,
					pub discovery_keys: ::subxt::alloc::vec::Vec<
						runtime_types::sp_authority_discovery::app::Public,
					>,
					pub assignment_keys: ::subxt::alloc::vec::Vec<
				...
				pub mod pallet {
					...
					pub enum Call {
						...
						claim_attest {
							...
							ethereum_signature:
								runtime_types::polkadot_runtime_common::claims::EcdsaSignature,
							statement: ::subxt::alloc::vec::Vec<::core::primitive::u8>,
						},
						#[codec(index = 3)]
						attest { statement: ::subxt::alloc::vec::Vec<::core::primitive::u8> },
						#[codec(index = 4)]
						move_claim {
			...
			pub mod crowdloan {
				...
				pub mod pallet {
					...
					pub enum Call {
						...
						add_memo {
							index: runtime_types::polkadot_parachain_primitives::primitives::Id,
							memo: ::subxt::alloc::vec::Vec<::core::primitive::u8>,
						},
						#[codec(index = 7)]
		...
		pub mod polkadot_runtime_parachains {
				...
				pub mod pallet {
					...
					pub enum Call {
                        ...
                        set_async_backing_params {
                            new: runtime_types::polkadot_primitives::v9::async_backing::AsyncBackingParams,
                        },
                        #[codec(index = 46)]
                        set_executor_params {
                            new: runtime_types::polkadot_primitives::v9::executor_params::ExecutorParams,
                        },
                        #[codec(index = 47)]
                        ...
                        set_approval_voting_params {
                            new: runtime_types::polkadot_primitives::v9::ApprovalVotingParams,
                        },
                        #[codec(index = 55)]
                        set_scheduler_params {
                            new: runtime_types::polkadot_primitives::vstaging::SchedulerParams<
                                ::core::primitive::u32,
                            >,
                        },
                        #[codec(index = 56)]
                        set_max_relay_parent_session_age { new: ::core::primitive::u32 },
                    }
					#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
					pub enum Error {
						#[codec(index = 0)]
				...
				pub mod pallet {
					...
					pub enum Call {
                        ...
                        assign_core {
                            ...
                            assignment: ::subxt::alloc::vec::Vec<
                                (
                                    runtime_types::pallet_broker::coretime_interface::CoreAssignment,
                                    runtime_types::polkadot_runtime_parachains::scheduler::assigner_coretime::PartsOf57600,
                                ),
                            >,
					...
					pub enum Event {
						...
						#[codec(index = 1)]
						CoreAssigned { core: runtime_types::polkadot_primitives::v9::CoreIndex },
					}
				}
			}
			pub mod disputes {
					...
					pub mod pallet {
						...
						pub enum Call {
							...
							report_dispute_lost_unsigned {
								dispute_proof: ::subxt::alloc::boxed::Box<
			...
			pub mod initializer {
				...
				pub struct BufferedSessionChange {
					pub validators: ::subxt::alloc::vec::Vec<
						runtime_types::polkadot_primitives::v9::validator_app::Public,
					>,
					pub queued: ::subxt::alloc::vec::Vec<
						runtime_types::polkadot_primitives::v9::validator_app::Public,
					>,
					pub session_index: ::core::primitive::u32,
				}
			...
			pub mod paras {
				...
				pub mod pallet {
					...
					pub enum Call {
                        ...
                        include_pvf_check_statement {
                            stmt: runtime_types::polkadot_primitives::v9::PvfCheckStatement,
                            signature: runtime_types::polkadot_primitives::v9::validator_app::Signature,
                        },
                        #[codec(index = 8)]
                        ...
                        authorize_force_set_current_code_hash {
                            para: runtime_types::polkadot_parachain_primitives::primitives::Id,
                            new_code_hash: runtime_types::polkadot_parachain_primitives::primitives::ValidationCodeHash,
                            valid_period: ::core::primitive::u32,
                        },
                        #[codec(index = 11)]
					...
					pub enum Event {
                        ...
                        CodeAuthorized {
                            para_id: runtime_types::polkadot_parachain_primitives::primitives::Id,
                            code_hash: runtime_types::polkadot_parachain_primitives::primitives::ValidationCodeHash,
                            expire_at: ::core::primitive::u32,
                        },
                    }
				}
				#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
				pub struct AuthorizedCodeHashAndExpiry<_0> {
                    pub code_hash: runtime_types::polkadot_parachain_primitives::primitives::ValidationCodeHash,
                    pub expire_at: _0,
                }
				#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
				...
				pub struct ParaPastCodeMeta<_0> {
					pub upgrade_times: ::subxt::alloc::vec::Vec<
				...
				pub struct PvfCheckActiveVoteState<_0> {
					...
					pub created_at: _0,
					pub causes: ::subxt::alloc::vec::Vec<
			...
			pub mod scheduler {
				...
				pub mod assigner_coretime {
					...
					pub struct AssignmentState {
                        pub ratio: runtime_types::polkadot_runtime_parachains::scheduler::assigner_coretime::PartsOf57600,
                        pub remaining: runtime_types::polkadot_runtime_parachains::scheduler::assigner_coretime::PartsOf57600,
                    }
					#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
					pub struct CoreDescriptor<_0> {
                        pub queue: ::core::option::Option<
                            runtime_types::polkadot_runtime_parachains::scheduler::assigner_coretime::QueueDescriptor<
                                _0,
                            >,
                        >,
                        pub current_work: ::core::option::Option<
                            runtime_types::polkadot_runtime_parachains::scheduler::assigner_coretime::WorkState<
                                _0,
                            >,
                        >,
                    }
					...
					pub struct WorkState<_0> {
                        pub assignments: ::subxt::alloc::vec::Vec<
                            (
                                runtime_types::pallet_broker::coretime_interface::CoreAssignment,
                                runtime_types::polkadot_runtime_parachains::scheduler::assigner_coretime::AssignmentState,
                            ),
                        >,
                        pub end_hint: ::core::option::Option<_0>,
                        pub pos: ::core::primitive::u16,
                        pub step: runtime_types::polkadot_runtime_parachains::scheduler::assigner_coretime::PartsOf57600,
                    }
				}
				pub mod pallet {
					use super::runtime_types;
		...
		pub mod sp_mmr_primitives {
			...
			pub struct AncestryProof<_0> {
				pub prev_peaks: ::subxt::alloc::vec::Vec<_0>,
				pub prev_leaf_count: ::core::primitive::u64,
				pub leaf_count: ::core::primitive::u64,
				pub items: ::subxt::alloc::vec::Vec<(::core::primitive::u64, _0)>,
			}
		}
		pub mod sp_npos_elections {
			...
			pub struct Support<_0> {
				pub total: ::core::primitive::u128,
				pub voters: ::subxt::alloc::vec::Vec<(_0, ::core::primitive::u128)>,
			}
		}
		pub mod sp_runtime {
			use super::runtime_types;
		...
		pub mod staging_kusama_runtime {
			...
			pub mod dynamic_params {
				...
				pub mod ah_client {
					use super::runtime_types;
					#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
					pub struct MinimumValidatorSetSize;
					#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
					pub enum Parameters {
						#[codec(index = 0)]
                        MinimumValidatorSetSize(
                            runtime_types::staging_kusama_runtime::dynamic_params::ah_client::MinimumValidatorSetSize,
					...
					pub enum ParametersValue {
						#[codec(index = 0)]
						MinimumValidatorSetSize(::core::primitive::u32),
					}
				}
				pub mod inflation {
					use super::runtime_types;
					...
					pub enum Parameters {
						#[codec(index = 0)]
                        MinInflation(
                            runtime_types::staging_kusama_runtime::dynamic_params::inflation::MinInflation,
                            ::core::option::Option<
                        ...
                        #[codec(index = 1)]
                        MaxInflation(
                            runtime_types::staging_kusama_runtime::dynamic_params::inflation::MaxInflation,
                            ::core::option::Option<
                                runtime_types::sp_arithmetic::per_things::Perquintill,
                            >,
                        ),
                        #[codec(index = 2)]
                        IdealStake(
                            runtime_types::staging_kusama_runtime::dynamic_params::inflation::IdealStake,
                            ::core::option::Option<
                                runtime_types::sp_arithmetic::per_things::Perquintill,
                            >,
                        ),
                        #[codec(index = 3)]
                        Falloff(
                            runtime_types::staging_kusama_runtime::dynamic_params::inflation::Falloff,
                            ::core::option::Option<
                                runtime_types::sp_arithmetic::per_things::Perquintill,
                            >,
                        ),
                        #[codec(index = 4)]
                        UseAuctionSlots(
                            runtime_types::staging_kusama_runtime::dynamic_params::inflation::UseAuctionSlots,
				...
				pub mod treasury {
					...
					pub enum Parameters {
						#[codec(index = 0)]
                        BurnPortion(
                            runtime_types::staging_kusama_runtime::dynamic_params::treasury::BurnPortion,
                            ::core::option::Option<
                        ...
                        #[codec(index = 1)]
                        BurnDestination(
                            runtime_types::staging_kusama_runtime::dynamic_params::treasury::BurnDestination,
                            ::core::option::Option<
                                runtime_types::staging_kusama_runtime::BurnDestinationAccount,
                            >,
                        ),
                    }
					#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
					...
					pub enum ParametersValue {
						#[codec(index = 0)]
						BurnPortion(runtime_types::sp_arithmetic::per_things::Permill),
						#[codec(index = 1)]
						BurnDestination(
							runtime_types::staging_kusama_runtime::BurnDestinationAccount,
						),
			...
			#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
			pub struct BurnDestinationAccount(
				pub ::core::option::Option<::sp_core::crypto::AccountId32>,
			);
			#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
			pub struct NposCompactSolution24 {
				...
				pub votes17: ::subxt::alloc::vec::Vec<(
					::subxt::ext::codec::Compact<::core::primitive::u32>,
					[(
						::subxt::ext::codec::Compact<::core::primitive::u16>,
						::subxt::ext::codec::Compact<
				...
				pub votes18: ::subxt::alloc::vec::Vec<(
					::subxt::ext::codec::Compact<::core::primitive::u32>,
					[(
						::subxt::ext::codec::Compact<::core::primitive::u16>,
						::subxt::ext::codec::Compact<
				...
				pub votes19: ::subxt::alloc::vec::Vec<(
					::subxt::ext::codec::Compact<::core::primitive::u32>,
					[(
						::subxt::ext::codec::Compact<::core::primitive::u16>,
						::subxt::ext::codec::Compact<
				...
				pub votes20: ::subxt::alloc::vec::Vec<(
					::subxt::ext::codec::Compact<::core::primitive::u32>,
					[(
						::subxt::ext::codec::Compact<::core::primitive::u16>,
						::subxt::ext::codec::Compact<
				...
				pub votes21: ::subxt::alloc::vec::Vec<(
					::subxt::ext::codec::Compact<::core::primitive::u32>,
					[(
						::subxt::ext::codec::Compact<::core::primitive::u16>,
						::subxt::ext::codec::Compact<
				...
				pub votes22: ::subxt::alloc::vec::Vec<(
					::subxt::ext::codec::Compact<::core::primitive::u32>,
					[(
						::subxt::ext::codec::Compact<::core::primitive::u16>,
						::subxt::ext::codec::Compact<
				...
				pub votes23: ::subxt::alloc::vec::Vec<(
					::subxt::ext::codec::Compact<::core::primitive::u32>,
					[(
						::subxt::ext::codec::Compact<::core::primitive::u16>,
						::subxt::ext::codec::Compact<
				...
				pub votes24: ::subxt::alloc::vec::Vec<(
					::subxt::ext::codec::Compact<::core::primitive::u32>,
					[(
						::subxt::ext::codec::Compact<::core::primitive::u16>,
						::subxt::ext::codec::Compact<
			...
			pub enum OriginCaller {
                ...
                #[codec(index = 43)]
                Origins(
                    runtime_types::staging_kusama_runtime::governance::origins::pallet_custom_origins::Origin,
                ),
                #[codec(index = 50)]
                ParachainsOrigin(
			...
			pub enum RuntimeCall {
				...
				#[codec(index = 48)]
				StakingAhClient(runtime_types::pallet_staking_async_ah_client::pallet::Call),
				#[codec(index = 51)]
				Configuration(
			...
			pub enum RuntimeError {
				...
				#[codec(index = 48)]
				StakingAhClient(runtime_types::pallet_staking_async_ah_client::pallet::Error),
				#[codec(index = 51)]
				Configuration(
				...
				#[codec(index = 255)]
				RcMigrator(runtime_types::pallet_rc_migrator::pallet::Error),
			}
			#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
			pub enum RuntimeEvent {
				...
				#[codec(index = 48)]
				StakingAhClient(runtime_types::pallet_staking_async_ah_client::pallet::Event),
				#[codec(index = 53)]
			...
			pub enum RuntimeHoldReason {
				#[codec(index = 6)]
				Staking(runtime_types::pallet_staking::pallet::pallet::HoldReason),
				#[codec(index = 8)]
			...
			pub enum RuntimeParameters {
				#[codec(index = 0)]
				Inflation(
					runtime_types::staging_kusama_runtime::dynamic_params::inflation::Parameters,
				),
				#[codec(index = 1)]
				Treasury(
					runtime_types::staging_kusama_runtime::dynamic_params::treasury::Parameters,
				),
				#[codec(index = 2)]
				AhClient(
					runtime_types::staging_kusama_runtime::dynamic_params::ah_client::Parameters,
				),
			}
			#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
			pub enum RuntimeParametersKey {
				#[codec(index = 0)]
				Inflation(
					runtime_types::staging_kusama_runtime::dynamic_params::inflation::ParametersKey,
				),
				#[codec(index = 1)]
				Treasury(
					runtime_types::staging_kusama_runtime::dynamic_params::treasury::ParametersKey,
				),
				#[codec(index = 2)]
				AhClient(
					runtime_types::staging_kusama_runtime::dynamic_params::ah_client::ParametersKey,
				),
			}
			#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
			pub enum RuntimeParametersValue {
				#[codec(index = 0)]
                Inflation(
                    runtime_types::staging_kusama_runtime::dynamic_params::inflation::ParametersValue,
                ),
                #[codec(index = 1)]
                Treasury(
                    runtime_types::staging_kusama_runtime::dynamic_params::treasury::ParametersValue,
                ),
                #[codec(index = 2)]
                AhClient(
                    runtime_types::staging_kusama_runtime::dynamic_params::ah_client::ParametersValue,
                ),
            }
			#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
