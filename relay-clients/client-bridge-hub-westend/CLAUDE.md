# client-bridge-hub-westend

Relay client for the **BridgeHub-Westend** testnet parachain.

## Chain type

Parachain (no GRANDPA). Handles cross-chain message passing for the Westend side.
