	...
	pub mod runtime_types {
		...
		pub mod bridge_hub_rococo_runtime {
			...
			pub enum RuntimeEvent {
				...
				#[codec(index = 51)]
				BridgeWestendMessages(runtime_types::pallet_bridge_messages::pallet::Event1),
				#[codec(index = 52)]
				XcmOverBridgeHubWestend(runtime_types::pallet_xcm_bridge_hub::pallet::Event1),
				#[codec(index = 60)]
				...
				#[codec(index = 62)]
				XcmOverPolkadotBulletin(runtime_types::pallet_xcm_bridge_hub::pallet::Event2),
				#[codec(index = 63)]
				BridgeRelayersForPermissionlessLanes(
