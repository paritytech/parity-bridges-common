...
impl HeadersRelayer for PolkadotBulletinToPeoplePolkadotCliBridge {}
...
impl RelayHeaders {
	...
	pub async fn run(self) -> anyhow::Result<()> {
		match self.bridge {
			...
			RelayHeadersBridge::PolkadotBulletinToPeoplePolkadot =>
				PolkadotBulletinToPeoplePolkadotCliBridge::relay_headers(self.params),
...
impl RelayHeader {
	...
	pub async fn run(self) -> anyhow::Result<()> {
		match self.bridge {
			...
			RelayHeadersBridge::PolkadotBulletinToPeoplePolkadot =>
				PolkadotBulletinToPeoplePolkadotCliBridge::relay_header(self.params),
			RelayHeadersBridge::RococoToRococoBulletin =>
